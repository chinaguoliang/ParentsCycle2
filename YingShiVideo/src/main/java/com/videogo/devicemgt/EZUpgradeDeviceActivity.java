...
public class EZUpgradeDeviceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.videogo.open.R.layout.activity_ezupgrade_device);
        initTitleBar();
        find_views();
        init_views();
    }
    ...
    private void find_views() {
        mUpgradeLL = (LinearLayout) findViewById(com.videogo.open.R.id.ezupgrade_ll_btn);
        mUpgradeProgressLL = (LinearLayout) findViewById(com.videogo.open.R.id.ezupgrade_ll_progress);
        mUpgradeButton = (Button) findViewById(com.videogo.open.R.id.ezupgrade_button);
        mProgressTextView = (TextView) findViewById(com.videogo.open.R.id.ezupgrade_progress_text);
        mVersionDescTextView = (TextView) findViewById(com.videogo.open.R.id.ezupgrade_text_version_desc);
    }
...
//        checkUpgradeStatusPeriodical();
    ...
    private void initTitleBar() {
        ...
        mTitleBar.setTitle(com.videogo.open.R.string.ez_device_upgrade);
    }
