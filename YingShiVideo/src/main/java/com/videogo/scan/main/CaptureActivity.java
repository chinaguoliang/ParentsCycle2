...
//        super.setPageKey(HikStatPageConstant.HIK_STAT_PAGE_NEW_SCAN);
        ...
        setContentView(com.videogo.open.R.layout.capture_activity);
    ...
    private void initTitleBar() {
        ...
        mTitleBar.setTitle(com.videogo.open.R.string.ez_scan_title_txt);
        ...
        mBtnRight = mTitleBar.addRightButton(com.videogo.open.R.drawable.common_title_input_selector, new OnClickListener() {
    ...
    private void findViews() {
        ckbLight = (CheckBox) findViewById(com.videogo.open.R.id.ckbLight);
        setmViewfinderView((ViewfinderView) findViewById(com.videogo.open.R.id.viewfinder_view));
        mTxtResult = (TextView) findViewById(com.videogo.open.R.id.txtResult);
        boolean isLightOn = getPramaFrontLight();
        ckbLight.setChecked(isLightOn);
        // mA1DeviceSeries不为空 表示 从a1界面进来扫描
        if (!TextUtils.isEmpty(mA1DeviceSeries)) {
            mTxtResult.setText(com.videogo.open.R.string.scan_search_probe_qrcode);
        ...
        new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                if (mHasMeasured == false) {
                    ...
                    mHasMeasured = true;
                    openPromptWindow(findViewById(com.videogo.open.R.id.flt_layout));
                }
                return true;
            }
        });
    ...
    protected void onResume() {
        ...
        SurfaceView surfaceView = (SurfaceView) findViewById(com.videogo.open.R.id.preview_view);
    ...
    private void decodeOrStoreSavedBitmap(Bitmap bitmap, Result result) {
        ...
        if (handler == null) {
            ...
            if (savedResultToShow != null) {
                Message message = Message.obtain(handler, com.videogo.open.R.id.decode_succeeded, savedResultToShow);
        ...
        if (!TextUtils.isEmpty(mA1DeviceSeries)) {
            ...
            if (!goAddProbe(resultString)) {
                ...
                if (isDeviceQRCode(resultString)) {
                    showToast(com.videogo.open.R.string.scan_probe_qrcode_error);
                } else {
...
*/
    ...
    private void showDecodeFailedTip() {
        ...
        view.setText(com.videogo.open.R.string.unable_identify_two_dimensional_code_tip);
        view.setTextSize(20);
        view.setTextColor(getResources().getColor(com.videogo.open.R.color.common_text));
        view.setBackgroundResource(com.videogo.open.R.drawable.decode_failed_tip_bg);
...
//        }
    ...
    private void isValidate() {
        ...
        if (!ConnectionDetector.isNetworkAvailable(this)) {
            showToast(com.videogo.open.R.string.query_camera_fail_network_exception);
            return;
        }
    ...
    private void displayFrameworkBugMessageAndExit() {
        showToast(com.videogo.open.R.string.open_camera_fail);

    }

    public void restartPreviewAfterDelay(long delayMS) {
        if (handler != null) {
            handler.sendEmptyMessageDelayed(com.videogo.open.R.id.restart_preview, delayMS);
        }
        // resetStatusView();
    }
    ...
    private void initBeepSound() {
        if (mPlayBeep) {
            ...
            AssetFileDescriptor file = getResources().openRawResourceFd(com.videogo.open.R.raw.beep);
            try {
...
//        WebUtils.openDeviceConnectHelp(this);
    ...
    public void finish() {
        super.finish();
        this.overridePendingTransition(0, com.videogo.open.R.anim.fade_down);
    }
