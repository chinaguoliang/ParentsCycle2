...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        maskColor = resources.getColor(com.videogo.open.R.color.viewfinder_mask);
        resultColor = resources.getColor(com.videogo.open.R.color.result_view);
        // frameColor = resources.getColor(R.color.viewfinder_frame);
        laserColor = resources.getColor(com.videogo.open.R.color.viewfinder_laser);
        resultPointColor = resources.getColor(com.videogo.open.R.color.possible_result_points);
        // scannerAlpha = 0;
