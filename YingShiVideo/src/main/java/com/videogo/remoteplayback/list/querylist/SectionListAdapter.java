...
public class SectionListAdapter implements ListAdapter, OnItemClickListener, PinnedHeaderAdapter, SectionIndexer,
    ...
    protected void setSectionText(final String section, final View sectionView) {
        final TextView textView = (TextView) sectionView.findViewById(com.videogo.open.R.id.header);
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = inflater.inflate(com.videogo.open.R.layout.section_list_item, null);
            holder.header = (TextView) convertView.findViewById(com.videogo.open.R.id.header);

            holder.image1 = (ImageView) convertView.findViewById(com.videogo.open.R.id.image1);
            holder.image2 = (ImageView) convertView.findViewById(com.videogo.open.R.id.image2);
            holder.image3 = (ImageView) convertView.findViewById(com.videogo.open.R.id.image3);
            ...
            holder.text1 = (TextView) convertView.findViewById(com.videogo.open.R.id.text1);
            holder.text2 = (TextView) convertView.findViewById(com.videogo.open.R.id.text2);
            holder.text3 = (TextView) convertView.findViewById(com.videogo.open.R.id.text3);

            holder.layout1 = (LinearLayout) convertView.findViewById(com.videogo.open.R.id.local_l1);
            holder.layout2 = (LinearLayout) convertView.findViewById(com.videogo.open.R.id.local_l2);
            holder.layout3 = (LinearLayout) convertView.findViewById(com.videogo.open.R.id.local_l3);

            holder.localTimePart1 = (TextView) convertView.findViewById(com.videogo.open.R.id.local_time_part1);
            holder.localTimePart2 = (TextView) convertView.findViewById(com.videogo.open.R.id.local_time_part2);
            holder.localTimePart3 = (TextView) convertView.findViewById(com.videogo.open.R.id.local_time_part3);

            holder.localAlarm1 = (ImageView) convertView.findViewById(com.videogo.open.R.id.local_alarm1);
            holder.localAlarm2 = (ImageView) convertView.findViewById(com.videogo.open.R.id.local_alarm2);
            holder.localAlarm3 = (ImageView) convertView.findViewById(com.videogo.open.R.id.local_alarm3);

            holder.check1 = (CheckBox) convertView.findViewById(com.videogo.open.R.id.check1);
            holder.check2 = (CheckBox) convertView.findViewById(com.videogo.open.R.id.check2);
            holder.check3 = (CheckBox) convertView.findViewById(com.videogo.open.R.id.check3);

            holder.moreBtn = (TextView) convertView.findViewById(com.videogo.open.R.id.more_btn);
            holder.moreLayout = (LinearLayout) convertView.findViewById(com.videogo.open.R.id.layout_more_ly);
        ...
        if (fileEx.isMore()) {
            convertView.findViewById(com.videogo.open.R.id.header_parent).setVisibility(View.GONE);
            convertView.findViewById(com.videogo.open.R.id.layout).setVisibility(View.GONE);
            convertView.findViewById(com.videogo.open.R.id.header).setVisibility(View.GONE);
            holder.moreBtn.setVisibility(View.VISIBLE);
            holder.moreLayout.setVisibility(View.VISIBLE);
            if (isEdit) {
                holder.moreBtn.setText(com.videogo.open.R.string.local_video_not_delete);
                holder.moreBtn.setTextColor(inflater.getContext().getResources().getColor(com.videogo.open.R.color.common_hint_text));
                holder.moreLayout.setOnClickListener(null);
                int resId = com.videogo.open.R.drawable.put_ico;
                Drawable drawable = linkedAdapter.getContext().getResources().getDrawable(resId);
                drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
                holder.moreBtn.setCompoundDrawables(null, null, drawable, null);
            } else {
                holder.moreBtn.setText(com.videogo.open.R.string.more_local_image);
                holder.moreBtn.setTextColor(inflater.getContext().getResources().getColor(com.videogo.open.R.color.more_color));
                holder.moreLayout.setOnClickListener(new OnHikMoreClickListener(holder.moreBtn));
                int resId = isExpand ? com.videogo.open.R.drawable.playback_more_up1 : com.videogo.open.R.drawable.playback_more_down1;
                Drawable drawable = linkedAdapter.getContext().getResources().getDrawable(resId);
                drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
                holder.moreBtn.setCompoundDrawables(null, null, drawable, null);
            }
            ...
            convertView.findViewById(com.videogo.open.R.id.header_parent).setVisibility(View.VISIBLE);
            convertView.findViewById(com.videogo.open.R.id.layout).setVisibility(View.VISIBLE);
            convertView.findViewById(com.videogo.open.R.id.header).setVisibility(View.VISIBLE);
        ...
        if (dataOne != null) {
            holder.image1.setImageResource(com.videogo.open.R.drawable.playback_cover2);
            if (dataOne.isCloud()) {
        ...
        if (dataTwo != null) {
            holder.image2.setImageResource(com.videogo.open.R.drawable.playback_cover2);
            if (dataTwo.isCloud()) {
        ...
        if (dataThree != null) {
            holder.image3.setImageResource(com.videogo.open.R.drawable.playback_cover2);
    ...
    private void imageLoader(String picUrl, ImageView imageView) {
        DisplayImageOptions options = new DisplayImageOptions.Builder().cacheInMemory(true).cacheOnDisk(true)
                .needDecrypt(false).considerExifParams(true).showImageForEmptyUri(com.videogo.open.R.drawable.playback_cover2)
                .showImageOnFail(com.videogo.open.R.drawable.playback_cover2).showImageOnDecryptFail(com.videogo.open.R.drawable.playback_cover2)
                .method(false).build();
    ...
    class OnHikMoreClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            if (onHikItemClickListener != null) {
                ...
                resId = isExpand ? com.videogo.open.R.drawable.playback_more_up1 : com.videogo.open.R.drawable.playback_more_down1;
                Drawable drawable = linkedAdapter.getContext().getResources().getDrawable(resId);
                drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
    ...
    public void configurePinnedHeader(View header, int position, int alpha) {
        ...
        int section = getSectionForPosition(realPosition);
        if (section < 0) {
            header.findViewById(com.videogo.open.R.id.header_text).setVisibility(View.GONE);
            header.findViewById(com.videogo.open.R.id.timeline_image).setVisibility(View.GONE);
            header.findViewById(com.videogo.open.R.id.separate_line).setVisibility(View.GONE);
        } else {
            if (section >= mIndexer.getSections().length) {
                return;
            }
            String title = (String) mIndexer.getSections()[section];
            TextView headerText = (TextView) header.findViewById(com.videogo.open.R.id.header_text);
            headerText.setText(getSpannableString(title));
            headerText.setVisibility(View.VISIBLE);
            ImageView timeLine = (ImageView) header.findViewById(com.videogo.open.R.id.timeline_image);
            timeLine.setVisibility(View.VISIBLE);
            header.findViewById(com.videogo.open.R.id.separate_line).setVisibility(View.VISIBLE);
