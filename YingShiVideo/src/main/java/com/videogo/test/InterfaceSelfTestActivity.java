...
public class InterfaceSelfTestActivity extends Activity implements View.OnClickListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.videogo.open.R.layout.activity_interface_self_test);
        mMap = new HashMap<>();
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == com.videogo.open.R.id.interface_self_test_button) {
            testV32Interface();

        } else if (i == com.videogo.open.R.id.interface_v33_self_test_button) {
            testV33Interface();

        } else if (i == com.videogo.open.R.id.id_interface_self_test_openCloudPage) {
        ...
        } else if (i == com.videogo.open.R.id.id_interface_self_test_forgetPassword) {
            EZOpenSDK.getInstance().openChangePasswordPage();

        } else if (i == com.videogo.open.R.id.id_show_stream_limit_dialog2) {
    ...
    private void findViews() {
        mSerialEdit=(EditText) findViewById(com.videogo.open.R.id.interface_self_test_editText);
        mTestButton = (Button) findViewById(com.videogo.open.R.id.interface_self_test_button);
