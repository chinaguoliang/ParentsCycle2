...
public class GroupLayout extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.videogo.open.R.styleable.GroupLayout);

        mDividerHeight = a.getDimensionPixelSize(com.videogo.open.R.styleable.GroupLayout_dividerHeight, 0);
        //mDividerPadding = a.getDimensionPixelSize(com.videogo.open.R.styleable.GroupLayout_dividerPadding, 0);
        mDividerColor = a.getColor(com.videogo.open.R.styleable.GroupLayout_dividerColor, Color.TRANSPARENT);
        mItemSelectorResId = a.getResourceId(com.videogo.open.R.styleable.GroupLayout_itemSelector, 0);
