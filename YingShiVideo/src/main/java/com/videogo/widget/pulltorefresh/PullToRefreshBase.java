...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // Styleables from XML
        TypedArray a = context.obtainStyledAttributes(attrs, com.videogo.open.R.styleable.PullToRefresh);
         ...
         * Styleables from XML
         */
        if (a.hasValue(com.videogo.open.R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
            Drawable background = a.getDrawable(com.videogo.open.R.styleable.PullToRefresh_ptrRefreshableViewBackground);
            if (null != background) {
                mRefreshableView.setBackgroundDrawable(background);
            }
        }

        if (a.hasValue(com.videogo.open.R.styleable.PullToRefresh_ptrOverScroll)) {
            mOverScrollEnabled = a.getBoolean(com.videogo.open.R.styleable.PullToRefresh_ptrOverScroll, true);
        }

        if (a.hasValue(com.videogo.open.R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled)) {
            mScrollingWhileRefreshingEnabled = a.getBoolean(
                    com.videogo.open.R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled, false);
        }
