...
public class PullToRefreshFooter extends LoadingLayout {
    ...
    public PullToRefreshFooter(Context context, Style style) {
        ...
        setContentView(com.videogo.open.R.layout.pull_to_refresh_footer);

        mLoadLayout = (LinearLayout) findViewById(com.videogo.open.R.id.footer_loading_layout);
        mHintView = (TextView) findViewById(com.videogo.open.R.id.footer_hint);
        mHintMoreView = (TextView) findViewById(com.videogo.open.R.id.footer_hint_more);
        mStyle = style;
    }

    @Override
    public void pullToRefresh() {
        mHintView.setText(com.videogo.open.R.string.xlistview_footer_hint_normal);
    }
    ...
    public void releaseToRefresh() {
        mHintView.setText(com.videogo.open.R.string.xlistview_footer_hint_ready);
    }
    ...
    public void disableRefresh() {
        ...
        mHintView.setText(com.videogo.open.R.string.xlistview_footer_no_more);
