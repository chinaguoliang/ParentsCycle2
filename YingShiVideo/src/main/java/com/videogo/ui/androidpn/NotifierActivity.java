...
public class NotifierActivity extends Activity implements OnIconClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.videogo.open.R.layout.notifier_page);
    ...
    private void findView() {
        myRelativeLayout = (LinearLayout) findViewById(com.videogo.open.R.id.myRelativeLayout);
        ...
        mAlarmListLy = (LinearLayout) findViewById(com.videogo.open.R.id.alarmlist_ly);
        mCloseBtn = (Button) findViewById(com.videogo.open.R.id.alarm_close_btn);
        ...
        mAlarmLv = (ListView) findViewById(com.videogo.open.R.id.alarmlist_lv);
    }
