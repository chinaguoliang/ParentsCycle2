...
public class RemoteFileTimeBar extends ImageView {
    ...
    private void init(Context context) {
        ...
        mPaint.setColor(mContext.getResources().getColor(com.videogo.open.R.color.remotefile_timebar_color));
        mAlarmPaint.setColor(mContext.getResources().getColor(com.videogo.open.R.color.remotefile_timebar_alarm_color));
        mTransPaint.setColor(mContext.getResources().getColor(com.videogo.open.R.color.transparent));

        mTimePaint.setColor(mContext.getResources().getColor(com.videogo.open.R.color.remotefile_timebar_color));
