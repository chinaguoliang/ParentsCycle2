...
public class EZRemotePlayBackActivity extends Activity implements OnClickListener, SurfaceHolder.Callback, 
    ...
    private  void initView() {
        setContentView(com.videogo.open.R.layout.ez_remote_playback_page);
        // 保持屏幕常亮
        ...
        mLandscapeTitleBar = (TitleBar) findViewById(com.videogo.open.R.id.pb_notlist_title_bar_landscape);
...
//        mLandscapeTitleBar.setOnTouchListener(this);
        ...
        if(mAlarmStartTime == null) {
            ...
            mTitleBar.addTitleButton(com.videogo.open.R.drawable.remote_cal_selector, new OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDatePicker();
                }
        ...
        mRemotePlayBackPageLy = (RelativeLayout)findViewById(com.videogo.open.R.id.remoteplayback_page_ly);
        /** 测量状态栏高度 **/
        ...
        mRemotePlayBackSv = (SurfaceView) findViewById(com.videogo.open.R.id.remoteplayback_sv);
        ...
        mRemotePlayBackLoadingLy = (LinearLayout)findViewById(com.videogo.open.R.id.remoteplayback_loading_ly);
        mRemotePlayBackLoadingPbLy = (LinearLayout)findViewById(com.videogo.open.R.id.remoteplayback_loading_pb_ly);
        mRemotePlayBackLoadingTv = (TextView) findViewById(com.videogo.open.R.id.remoteplayback_loading_tv);
        mRemotePlayBackTipTv = (TextView)findViewById(com.videogo.open.R.id.remoteplayback_tip_tv);
        mRemotePlayBackReplayBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_replay_btn);
        mRemotePlayBackLoadingPlayBtn = (ImageButton) findViewById(com.videogo.open.R.id.remoteplayback_loading_play_btn);
        
        mRemotePlayBackControlRl = (RelativeLayout)findViewById(com.videogo.open.R.id.remoteplayback_control_rl);
        mRemotePlayBackBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_play_btn);
        mRemotePlayBackSoundBtn = (ImageButton) findViewById(com.videogo.open.R.id.remoteplayback_sound_btn);
        mRemotePlayBackFlowTv = (TextView)findViewById(com.videogo.open.R.id.remoteplayback_flow_tv);
        mRemotePlayBackFlowTv.setText("0k/s 0MB");
        
        mRemotePlayBackProgressLy = (LinearLayout)findViewById(com.videogo.open.R.id.remoteplayback_progress_ly);
        mRemotePlayBackBeginTimeTv = (TextView)findViewById(com.videogo.open.R.id.remoteplayback_begin_time_tv);
        mRemotePlayBackEndTimeTv = (TextView)findViewById(com.videogo.open.R.id.remoteplayback_end_time_tv);
        mRemotePlayBackSeekBar = (SeekBar)findViewById(com.videogo.open.R.id.remoteplayback_progress_seekbar);
        mRemotePlayBackProgressBar = (ProgressBar)findViewById(com.videogo.open.R.id.remoteplayback_progressbar);
        
        mRemotePlayBackCaptureRl = (RelativeLayout)findViewById(com.videogo.open.R.id.remoteplayback_capture_rl);
        mRemotePlayBackCaptureRlLp = (RelativeLayout.LayoutParams) mRemotePlayBackCaptureRl.getLayoutParams();
        mRemotePlayBackCaptureIv = (ImageView)findViewById(com.videogo.open.R.id.remoteplayback_capture_iv);
        mRemotePlayBackCaptureWatermarkIv = (ImageView)findViewById(com.videogo.open.R.id.remoteplayback_capture_watermark_iv);
        mRemotePlayBackRecordLy = (LinearLayout)findViewById(com.videogo.open.R.id.remoteplayback_record_ly);
        mRemotePlayBackRecordIv = (ImageView) findViewById(com.videogo.open.R.id.remoteplayback_record_iv);
        mRemotePlayBackRecordTv = (TextView)findViewById(com.videogo.open.R.id.remoteplayback_record_tv);
        
        mRemotePlayBackOperateBar = (LinearLayout)findViewById(com.videogo.open.R.id.remoteplayback_operate_bar);
        mRemotePlayBackCaptureBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_previously_btn);
        mRemotePlayBackRecordBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_video_btn);
        mRemotePlayBackRecordContainer = findViewById(com.videogo.open.R.id.remoteplayback_video_container);
        mRemotePlayBackRecordStartBtn = (ImageButton) findViewById(com.videogo.open.R.id.remoteplayback_video_start_btn);

        mRemotePlayBackSmallCaptureBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_small_previously_btn);
        mRemotePlayBackSmallRecordBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_small_video_btn);
        mRemotePlayBackSmallRecordContainer = findViewById(com.videogo.open.R.id.remoteplayback_small_video_container);
        mRemotePlayBackSmallRecordStartBtn = (ImageButton) findViewById(com.videogo.open.R.id.remoteplayback_small_video_start_btn);
        
        mRemotePlayBackFullOperateBar = (RelativeLayout)findViewById(com.videogo.open.R.id.remoteplayback_full_operate_bar);
        mRemotePlayBackFullPlayBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_full_play_btn);
        mRemotePlayBackFullSoundBtn = (ImageButton) findViewById(com.videogo.open.R.id.remoteplayback_full_sound_btn);
        mRemotePlayBackFullCaptureBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_full_previously_btn);
        mRemotePlayBackFullRecordBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_full_video_btn);
        mRemotePlayBackFullRecordContainer = findViewById(com.videogo.open.R.id.remoteplayback_full_video_container);
        mRemotePlayBackFullRecordStartBtn = (ImageButton) findViewById(com.videogo.open.R.id.remoteplayback_full_video_start_btn);
        mRemotePlayBackFullDownBtn = (ImageButton)findViewById(com.videogo.open.R.id.remoteplayback_full_down_btn);
        
        mRemotePlayBackFullFlowLy = (LinearLayout)findViewById(com.videogo.open.R.id.remoteplayback_full_flow_ly);
        mRemotePlayBackFullRateTv = (TextView)findViewById(com.videogo.open.R.id.remoteplayback_full_rate_tv);
        mRemotePlayBackFullFlowTv = (TextView)findViewById(com.videogo.open.R.id.remoteplayback_full_flow_tv);
        mRemotePlayBackRatioTv = (TextView)findViewById(com.videogo.open.R.id.remoteplayback_ratio_tv);
        ...
        mRemotePlayBackTimeBarRl = (RelativeLayout) findViewById(com.videogo.open.R.id.remoteplayback_timebar_rl);
        mRemotePlayBackTimeBar = (TimeBarHorizontalScrollView) findViewById(com.videogo.open.R.id.remoteplayback_timebar);
        mRemotePlayBackTimeBar.setTimeScrollBarScrollListener(this);
        mRemotePlayBackTimeBar.smoothScrollTo(0, 0);
        mRemoteFileTimeBar = (RemoteFileTimeBar) findViewById(com.videogo.open.R.id.remoteplayback_file_time_bar);
        mRemoteFileTimeBar.setX(0, mLocalInfo.getScreenWidth() * 6);
        mRemotePlayBackTimeTv = (TextView) findViewById(com.videogo.open.R.id.remoteplayback_time_tv);
...
//                        stopRemotePlayBack();
    ...
    private void showDatePicker() {
        ...
        dpd.setTitle(com.videogo.open.R.string.select_date);
        dpd.setCanceledOnTouchOutside(true);
        dpd.setButton(DialogInterface.BUTTON_POSITIVE, getString(com.videogo.open.R.string.certain),
        ...
        dpd.setButton(DialogInterface.BUTTON_NEGATIVE, getString(com.videogo.open.R.string.cancel),
                new DialogInterface.OnClickListener() {
                    @Override
    ...
    protected void onResume() {
        ...
        if(mCameraInfo.getOnlineStatus() != 1) {
            ...
            setRemotePlayBackFailUI(getString(com.videogo.open.R.string.camera_not_online));
        } else {        
    ...
    private void updateSoundUI() {
        if (mLocalInfo.isSoundOpen()) {
            mRemotePlayBackSoundBtn.setBackgroundResource(com.videogo.open.R.drawable.remote_list_soundon_btn_selector);
            mRemotePlayBackFullSoundBtn.setBackgroundResource(com.videogo.open.R.drawable.play_full_soundon_btn_selector);
        } else {
            mRemotePlayBackSoundBtn.setBackgroundResource(com.videogo.open.R.drawable.remote_list_soundoff_btn_selector);
            mRemotePlayBackFullSoundBtn.setBackgroundResource(com.videogo.open.R.drawable.play_full_soundoff_btn_selector);
        }
    }
    ...
    private void updateOperatorUI() {
        if (mOrientation == Configuration.ORIENTATION_PORTRAIT) {
            // 显示状态栏
            fullScreen(false);
            mRemotePlayBackPageLy.setBackgroundColor(getResources().getColor(com.videogo.open.R.color.common_bg));
            ...
            if(mAlarmStartTime == null) {
                mRemoteFileTimeBar.setX(0, mLocalInfo.getScreenWidth() * 6);
                mRemotePlayBackTimeBarRl.setBackgroundColor(getResources().getColor(com.videogo.open.R.color.transparent));
                mRemotePlayBackTimeBarRl.setVisibility(View.VISIBLE);
            }
            ...
            // 隐藏状态栏
            fullScreen(true);
            mRemotePlayBackPageLy.setBackgroundColor(getResources().getColor(com.videogo.open.R.color.black_bg));
            mTitleBar.setVisibility(View.GONE);
            mRemotePlayBackOperateBar.setVisibility(View.GONE);
            if(mAlarmStartTime == null) {
                mRemotePlayBackFullOperateBar.setVisibility(View.GONE);
                mRemoteFileTimeBar.setX(0, mLocalInfo.getScreenHeight() * 6);
                mRemotePlayBackTimeBarRl.setBackgroundColor(getResources().getColor(com.videogo.open.R.color.play_translucent_bg));
                mRemotePlayBackTimeBarRl.setVisibility(View.GONE);
                mRemotePlayBackFullDownBtn.setBackgroundResource(com.videogo.open.R.drawable.palyback_full_up);
        ...
        switch (msg.what) {
            ...
            case RemotePlayBackMsg.MSG_REMOTEPLAYBACK_PASSWORD_ERROR:
                ...
                handlePasswordError(com.videogo.open.R.string.realplay_password_error_title,
                        com.videogo.open.R.string.realplay_password_error_message3,
                        com.videogo.open.R.string.realplay_password_error_message1);
                break;
            ...
            case RemotePlayBackMsg.MSG_START_RECORD_FAIL:
                Utils.showToast(this, com.videogo.open.R.string.remoteplayback_record_fail);
                break;
            ...
            case RemotePlayBackMsg.MSG_CAPTURE_PICTURE_FAIL:
                // 提示抓图失败
                Utils.showToast(this, com.videogo.open.R.string.remoteplayback_capture_fail);
                break;            
...
//                handleSearchEZDeviceFileSuccess();
    ...
    private void handleSearchNoFile() {
        ...
        if (mAlarmStartTime != null) {
            setRemotePlayBackFailUI(getString(com.videogo.open.R.string.remoteplayback_norecordfile_alarm));
        } else {
            setRemotePlayBackFailUI(getString(com.videogo.open.R.string.remoteplayback_norecordfile));
        }
    }
    ...
    private void handleSearchCloudFileFail(int errorCode) {        
        ...
        switch (errorCode) {
            ...
            case ErrorCode.ERROR_CAS_VERIFY_SESSION_ERROR:
                ...
                return;                
            default:
                txt = Utils.getErrorTip(this, com.videogo.open.R.string.remoteplayback_searchfile_fail_for_device, errorCode);
                break;
        }
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == com.videogo.open.R.id.remoteplayback_loading_play_btn) {
            startRemotePlayBack(getTimeBarSeekTime());

        } else if (i == com.videogo.open.R.id.remoteplayback_play_btn || i == com.videogo.open.R.id.remoteplayback_full_play_btn) {
        ...
        } else if (i == com.videogo.open.R.id.remoteplayback_replay_btn) {
            if (mStatus != STATUS_STOP) {
                stopRemotePlayBack();
            }
            startRemotePlayBack(null);

        } else if (i == com.videogo.open.R.id.remoteplayback_sound_btn || i == com.videogo.open.R.id.remoteplayback_full_sound_btn) {
            onSoundBtnClick();

        } else if (i == com.videogo.open.R.id.remoteplayback_previously_btn || i == com.videogo.open.R.id.remoteplayback_full_previously_btn || i == com.videogo.open.R.id.remoteplayback_small_previously_btn) {
            onCapturePicBtnClick();

        } else if (i == com.videogo.open.R.id.remoteplayback_capture_rl) {
            onCaptureRlClick();

        } else if (i == com.videogo.open.R.id.remoteplayback_video_btn || i == com.videogo.open.R.id.remoteplayback_full_video_btn || i == com.videogo.open.R.id.remoteplayback_small_video_btn || i == com.videogo.open.R.id.remoteplayback_video_start_btn || i == com.videogo.open.R.id.remoteplayback_full_video_start_btn || i == com.videogo.open.R.id.remoteplayback_small_video_start_btn) {
            onRecordBtnClick();

        } else if (i == com.videogo.open.R.id.remoteplayback_full_down_btn) {
    ...
    private void onTimeBarDownBtnClick() {
        if(mRemotePlayBackTimeBarRl.getVisibility() == View.VISIBLE) {
            ...
            mRemotePlayBackTimeBarRl.setVisibility(View.VISIBLE);
            mRemotePlayBackFullDownBtn.setBackgroundResource(com.videogo.open.R.drawable.palyback_full_down);
    ...
    private void onRecordBtnClick() {
        ...
        if (!SDCardUtil.isSDCardUseable()) {
            // 提示SD卡不可用
            Utils.showToast(this, com.videogo.open.R.string.remoteplayback_SDCard_disable_use);
            return;
        }

        if (SDCardUtil.getSDCardRemainSize() < SDCardUtil.PIC_MIN_MEM_SPACE) {
            // 提示内存不足
            Utils.showToast(this, com.videogo.open.R.string.remoteplayback_record_fail_for_memory);
            return;
        }
...
//        mRemotePlayBackCaptureRl.setVisibility(View.VISIBLE);
    ...
    private void onCapturePicBtnClick() {
        ...
        if (SDCardUtil.getSDCardRemainSize() < SDCardUtil.PIC_MIN_MEM_SPACE) {
            // 提示内存不足
            Utils.showToast(this, com.videogo.open.R.string.remoteplayback_capture_fail_for_memory);
            return;
        }
                    ...
                    if(bmp != null) {
                        try {
                            ...
                            runOnUiThread(new Runnable(){
                                @Override
                                public void run() {
                                    Toast.makeText(EZRemotePlayBackActivity.this, getResources().getString(com.videogo.open.R.string.already_saved_to_volume), Toast.LENGTH_SHORT).show();
                                }});
...
//                    			String endT = new SimpleDateFormat("yyyyMMddHHmmss").format(mAlarmStopTime.getTime());
    ...
    private void startRemotePlayBack(final Calendar selectedTime) {
        ...
        if (!ConnectionDetector.isNetworkAvailable(this)) {
            // 提示没有连接网络
            setRemotePlayBackFailUI(getString(com.videogo.open.R.string.remoteplayback_searchfile_fail_for_network));
            return;
        }
...
//        }
        ...
        mRemotePlayBackBtn.setBackgroundResource(com.videogo.open.R.drawable.remote_list_play_btn_selector);
        ...
        mRemotePlayBackFullPlayBtn.setBackgroundResource(com.videogo.open.R.drawable.play_full_play_selector);
        mRemotePlayBackFullCaptureBtn.setEnabled(false); 
        mRemotePlayBackFullRecordBtn.setEnabled(false); 
        updateSoundUI();
...
//        mRemotePlayBackFlowTv.setVisibility(View.VISIBLE);
        mRemotePlayBackFullFlowLy.setVisibility(View.VISIBLE);
        mRemotePlayBackBtn.setBackgroundResource(com.videogo.open.R.drawable.remote_list_pause_btn_selector);
        ...
        mRemotePlayBackFullPlayBtn.setEnabled(true);
        mRemotePlayBackFullPlayBtn.setBackgroundResource(com.videogo.open.R.drawable.play_full_pause_selector);
        ...
        switch (errorCode) {
	     ...
	     case ErrorCode.ERROR_DVR_LOGIN_USERID_ERROR:
            ...
            case InnerException.INNER_DEVICE_NOT_EXIST:
                txt = getString(com.videogo.open.R.string.camera_not_online);
                break;   
            case HCNetSDKException.NET_DVR_NETWORK_FAIL_CONNECT:
                txt = getString(com.videogo.open.R.string.remoteplayback_connect_device_error);
                break;
            case ErrorCode.ERROR_CAS_CONNECT_FAILED:
                txt = getString(com.videogo.open.R.string.remoteplayback_connect_server_error);
                break;
            ...
            case ErrorCode.ERROR_WEB_HARDWARE_SIGNATURE_OP_ERROR:
                ...
                break;               
            default:
                txt = Utils.getErrorTip(this, com.videogo.open.R.string.remoteplayback_fail, errorCode);
                break;
        }
