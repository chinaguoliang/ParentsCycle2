...
public class AutoWifiDiscoveringActivity extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == com.videogo.open.R.id.btnBack) {// 设备切换wifi界面来的，且已连接成功
    ...
    private void lineConnectClick() {
        ...
        tvTitle.setText(com.videogo.open.R.string.auto_wifi_network_add_device);
    ...
    private void changeStatuss(int Status) {
        switch (Status) {
            case STATUS_WIFI_CONNETCTING:
                ...
                imgStatus.setImageResource(com.videogo.open.R.drawable.auto_wifi_cicle_bg);
                imgAnimation.setVisibility(View.VISIBLE);
                imgStatus.setVisibility(View.VISIBLE);
                imgAnimation.setImageResource(com.videogo.open.R.drawable.auto_wifi_wait);
            ...
            case STATUS_REGISTING:
                tvStatus.setText(com.videogo.open.R.string.auto_wifi_connecting_msg2);
                imgStatus.setImageResource(com.videogo.open.R.drawable.auto_wifi_cicle_120);
                imgStatus.setVisibility(View.VISIBLE);
                imgAnimation.setImageResource(com.videogo.open.R.drawable.auto_wifi_wait);
                animWaiting = (AnimationDrawable) imgAnimation.getDrawable();
                animWaiting.start();
            ...
            case STATUS_ADDING_CAMERA:
                tvStatus.setText(com.videogo.open.R.string.auto_wifi_connecting_msg3);
                imgAnimation.setImageResource(com.videogo.open.R.drawable.auto_wifi_wait);
                imgStatus.setVisibility(View.VISIBLE);
                imgStatus.setImageResource(com.videogo.open.R.drawable.auto_wifi_cicle_240);
                animWaiting = (AnimationDrawable) imgAnimation.getDrawable();
                animWaiting.start();
                btnRetry.setVisibility(View.GONE);
                btnLineConnect.setVisibility(View.GONE);
            ...
            case STATUS_ADD_CAMERA_SUCCESS:
                tvStatus.setText(com.videogo.open.R.string.aotu_wifi_add_device_success);
                imgStatus.setImageResource(com.videogo.open.R.drawable.auto_wifi_add_success_2);
    ...
    private void addCameraFailed(int errorStep, int errorCode) {
        ...
        switch (errorStep) {
            case ERROR_WIFI_CONNECT:
                ...
                btnLineConnect.setText(com.videogo.open.R.string.auto_wifi_line_connect);
                imgAnimation.setImageResource(com.videogo.open.R.drawable.auto_wifi_failed);
                tvStatus.setText(com.videogo.open.R.string.auto_wifi_connecting_failed);
                // stopBonjourOnThread();
                break;
            case ERROR_REGIST:
                // stopBonjourOnThread();
            ...
            case ERROR_ADD_CAMERA:
                ...
                || errorCode == ErrorCode.ERROR_WEB_DIVICE_OFFLINE_ADDED) {
                    tvStatus.setText(com.videogo.open.R.string.scan_device_add_by_others);
                } else if (errorCode == ErrorCode.ERROR_WEB_DEVICE_NOTEXIT
                        || errorCode == ErrorCode.ERROR_WEB_DEVICE_NOT_EXIT) {
                    tvStatus.setText(com.videogo.open.R.string.device_not_exist);
                } else if (errorCode > 0) {
                    tvStatus.setText(Utils.getErrorTip(this, com.videogo.open.R.string.auto_wifi_add_device_failed, errorCode));
                } else {
    ...
    private void openAddDeviceDialog() {
        ...
        editText.setHint(com.videogo.open.R.string.input_device_verify_code);
        new  AlertDialog.Builder(AutoWifiDiscoveringActivity.this)
        .setTitle(this.getString(com.videogo.open.R.string.add_device) + serialNo)
    ...
    private class AddDeviceTask extends AsyncTask<SecurityEditText, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result != null && result) {
                Utils.showToast(AutoWifiDiscoveringActivity.this, com.videogo.open.R.string.add_device_success);
                changeStatuss(STATUS_ADD_CAMERA_SUCCESS);
            } else {
                Utils.showToast(AutoWifiDiscoveringActivity.this, com.videogo.open.R.string.add_device_fail, mErrorCode);
                addCameraFailed(ERROR_ADD_CAMERA, mErrorCode);
            }
        }
    }
