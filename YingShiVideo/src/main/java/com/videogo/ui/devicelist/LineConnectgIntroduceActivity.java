...
public class LineConnectgIntroduceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.videogo.open.R.layout.line_connecting_introduce_activity);
        tvIntroduce1 = (TextView) findViewById(com.videogo.open.R.id.tvIntroduce1);
        tvIntroduce2 = (TextView) findViewById(com.videogo.open.R.id.tvIntroduce2);
        initTitleBar();

        int fromPage = getIntent().getIntExtra(FROM_PAGE, 0);
        if (fromPage == FROM_PAGE_WIFI_CONFIG) {
            tvIntroduce1.setText(com.videogo.open.R.string.connect_device_to_router);
            tvIntroduce2.setVisibility(View.INVISIBLE);
        } else {
            tvIntroduce1.setText(com.videogo.open.R.string.device_wificonfig_hasline_introduce);
        }
    }
    ...
    private void initTitleBar() {
        ...
        mTitleBar.setTitle(com.videogo.open.R.string.wired_connection);
