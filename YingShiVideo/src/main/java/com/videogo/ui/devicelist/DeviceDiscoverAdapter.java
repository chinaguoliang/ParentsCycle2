...
public class DeviceDiscoverAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // 获取list_item布局文件的视图
            convertView = LayoutInflater.from(mContext).inflate(com.videogo.open.R.layout.device_discover_item, null);

            // 获取控件对象
            viewHolder.serialTv = (TextView) convertView.findViewById(com.videogo.open.R.id.serial_tv);
            viewHolder.wifiTv = (TextView) convertView.findViewById(com.videogo.open.R.id.wifi_tv);
            viewHolder.platTv = (TextView) convertView.findViewById(com.videogo.open.R.id.plat_tv);
            viewHolder.ipTv = (TextView) convertView.findViewById(com.videogo.open.R.id.ip_tv);
            viewHolder.addBtn = (Button) convertView.findViewById(com.videogo.open.R.id.add_btn);
            viewHolder.localRealPlayBtn = (Button) convertView.findViewById(com.videogo.open.R.id.local_realplay_btn);
        ...
        if(deviceDiscoverInfo != null) {
            ...
            if(deviceDiscoverInfo.isAdded) {
                viewHolder.addBtn.setText(deviceDiscoverInfo.cameraInfo!=null? com.videogo.open.R.string.added_by_me: com.videogo.open.R.string.added_by_other);
            } else {
                viewHolder.addBtn.setText(com.videogo.open.R.string.add_device);
            }
