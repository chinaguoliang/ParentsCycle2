...
//    private UnbindDeviceTriggerHelper mTriggerHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.videogo.open.R.layout.auto_wifi_connecting);
        // 唤醒，常亮
...
//            mDeviceInfoEx = DeviceManager.getInstance().getDeviceInfoExById(serialNo);
    ...
    private void findViews() {
        ...
        btnCancel = findViewById(com.videogo.open.R.id.cancel_btn);
        tvTitle = (TextView) findViewById(com.videogo.open.R.id.tvTitle);

        addCameraContainer = findViewById(com.videogo.open.R.id.addCameraContainer);
        lineConnectContainer = findViewById(com.videogo.open.R.id.lineConnectContainer);
        tvStatus = (TextView) findViewById(com.videogo.open.R.id.tvStatus);

        btnRetry = (TextView) findViewById(com.videogo.open.R.id.btnRetry);
        btnLineConnect = (Button) findViewById(com.videogo.open.R.id.btnLineConnet);
        btnLineConnetOk = findViewById(com.videogo.open.R.id.btnLineConnetOk);
        imgAnimation = (ImageView) findViewById(com.videogo.open.R.id.imgAnimation);
        btnFinish = findViewById(com.videogo.open.R.id.btnFinish);
        ckbCloundService = (CheckBox) findViewById(com.videogo.open.R.id.ckbCloundService);
        tvMore = findViewById(com.videogo.open.R.id.tvMore);
        llyCloundService = findViewById(com.videogo.open.R.id.llyCloundService);

        connectStateContainer = findViewById(com.videogo.open.R.id.connectStateContainer);
        llyStatus1 = findViewById(com.videogo.open.R.id.llyStatus1);
        llyStatus2 = findViewById(com.videogo.open.R.id.llyStatus2);
        llyStatus3 = findViewById(com.videogo.open.R.id.llyStatus3);
        helpTop = findViewById(com.videogo.open.R.id.helpTop);
        help = findViewById(com.videogo.open.R.id.help);
        tvDeviceWifiConfigTip = findViewById(com.videogo.open.R.id.tvDeviceWifiConfigTip);
        tvSuccess = findViewById(com.videogo.open.R.id.tvSuccess);
...
//        mTriggerHelper.onActivityResult(requestCode, resultCode, intent);
    ...
    private void showStatus(int status) {
        ...
        TextView tip = (TextView) llyStatus1.findViewById(com.videogo.open.R.id.tip);
        View successIcon = llyStatus1.findViewById(com.videogo.open.R.id.successIcon);
        final TextView timer = (TextView) llyStatus1.findViewById(com.videogo.open.R.id.timer);
        TextView tip2 = (TextView) llyStatus2.findViewById(com.videogo.open.R.id.tip);
        View successIcon2 = llyStatus2.findViewById(com.videogo.open.R.id.successIcon);
        final TextView timer2 = (TextView) llyStatus2.findViewById(com.videogo.open.R.id.timer);
        TextView tip3 = (TextView) llyStatus3.findViewById(com.videogo.open.R.id.tip);
        View successIcon3 = llyStatus3.findViewById(com.videogo.open.R.id.successIcon);
        final TextView timer3 = (TextView) llyStatus3.findViewById(com.videogo.open.R.id.timer);
        ...
        tip.setText(com.videogo.open.R.string.auto_wifi_tip_connecting_wifi);
        tip2.setText(com.videogo.open.R.string.auto_wifi_tip_connecting_server);
        tip3.setText(com.videogo.open.R.string.auto_wifi_tip_binding_account);
        tip.setTextSize(Utils.px2dip(this, getResources().getDimension(com.videogo.open.R.dimen.botton_text_size)));
        tip2.setTextSize(Utils.px2dip(this, getResources().getDimension(com.videogo.open.R.dimen.botton_text_size)));
        tip3.setTextSize(Utils.px2dip(this, getResources().getDimension(com.videogo.open.R.dimen.botton_text_size)));
        tip.setTextColor(getResources().getColor(com.videogo.open.R.color.upgrade_gray));
        tip2.setTextColor(getResources().getColor(com.videogo.open.R.color.upgrade_gray));
        tip3.setTextColor(getResources().getColor(com.videogo.open.R.color.upgrade_gray));
        tip3.setVisibility(View.VISIBLE);
        // 连接wifi
        if (STATUS_WIFI_CONNETCTING == status) {
            tip.setTextSize(Utils.px2dip(this, getResources().getDimension(com.videogo.open.R.dimen.tab_text_size)));
            tip.setTextColor(getResources().getColor(com.videogo.open.R.color.black));
            tip.setText(com.videogo.open.R.string.auto_wifi_tip_connecting_wifi_ing);
            ...
            tip2.setTextSize(Utils.px2dip(this, getResources().getDimension(com.videogo.open.R.dimen.tab_text_size)));
            tip2.setTextColor(getResources().getColor(com.videogo.open.R.color.black));
            tip.setText(com.videogo.open.R.string.auto_wifi_tip_connecting_wifi_ok);
            tip2.setText(com.videogo.open.R.string.auto_wifi_tip_connecting_server_ing);
            ...
            successIcon3.setVisibility(View.INVISIBLE);
            tip3.setTextSize(Utils.px2dip(this, getResources().getDimension(com.videogo.open.R.dimen.tab_text_size)));
            tip3.setTextColor(getResources().getColor(com.videogo.open.R.color.black));
            tip.setText(com.videogo.open.R.string.auto_wifi_tip_connecting_wifi_ok);
            tip2.setText(com.videogo.open.R.string.auto_wifi_tip_connecting_server_ok);
            tip3.setText(com.videogo.open.R.string.auto_wifi_tip_binding_account_ing);
    ...
    private void initUI() {
        if (fromPage == FROM_PAGE_SERIES_NUM_SEARCH_ACTIVITY) {
            tvTitle.setText(com.videogo.open.R.string.auto_wifi_title_add_device);
        } else {
            // 一切为了转圈
            // if (TextUtils.isEmpty(deviceType)) {
            tvTitle.setText(com.videogo.open.R.string.auto_wifi_title_add_device2);
            // } else {
...
//                            LocalInfo.getInstance().setWifiPassword(mac, wifiPassword);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == com.videogo.open.R.id.btnBack) {
            onBackPressed();


        } else if (i == com.videogo.open.R.id.cancel_btn) {
            cancelOnClick();

        } else if (i == com.videogo.open.R.id.btnRetry) {
            retryOnclick();

        } else if (i == com.videogo.open.R.id.btnLineConnet) {
            lineConnectClick();

        } else if (i == com.videogo.open.R.id.btnLineConnetOk) {
            lineConnectOkClick();

        } else if (i == com.videogo.open.R.id.btnFinish) {
            finishOnClick();

        } else if (i == com.videogo.open.R.id.tvMore) {
            moreOnClick();

        } else if (i == com.videogo.open.R.id.help) {
            helpOnclick();
...
//        WebUtils.openYsCloudIntro(this);
    ...
    private void enableCloudStoryed() {
        ...
        if (!ConnectionDetector.isNetworkAvailable(this)) {
            showToast(com.videogo.open.R.string.save_encrypt_password_fail_network_exception);
            return;
        }

        // mWaitDlg.show();
        showWaitDialog(com.videogo.open.R.string.start_cloud);
    ...
    private void lineConnectClick() {
        ...
        if (btnLineConnect.getVisibility() == View.VISIBLE) {
            tvTitle.setText(com.videogo.open.R.string.auto_wifi_line_connect_title);
        } else if (TextUtils.isEmpty(deviceType)) {
            tvTitle.setText(com.videogo.open.R.string.auto_wifi_network_add_device2);
        } else {
            tvTitle.setText(com.videogo.open.R.string.auto_wifi_network_add_device1);
        }
    ...
    private void showConfirmDialog() {
        new AlertDialog.Builder(this).setMessage(com.videogo.open.R.string.auto_wifi_dialog_connecting_msg)
                .setPositiveButton(com.videogo.open.R.string.update_exit, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        finish();
                    }
                }).setNegativeButton(com.videogo.open.R.string.wait, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                    }
    ...
    private void changeStatuss(int Status) {
        ...
        switch (Status) {
            case STATUS_WIFI_CONNETCTING:
                ...
                tvStatus.setText(com.videogo.open.R.string.auto_wifi_connecting_msg1);
                imgAnimation.setImageResource(com.videogo.open.R.drawable.connect_wifi_bg);
...
//                                    LocalInfo.getInstance().setWifiPassword(mac, wifiPassword);
                ...
                imgAnimation.setImageResource(com.videogo.open.R.drawable.register_server_bg);
                animWaiting = (AnimationDrawable) imgAnimation.getDrawable();
                animWaiting.start();
                btnRetry.setVisibility(View.GONE);
                btnLineConnect.setVisibility(View.GONE);
            ...
            case STATUS_ADDING_CAMERA:
                ...
                // } else {
                // }
                imgAnimation.setImageResource(com.videogo.open.R.drawable.auto_wifi_link_account_bg);
                animWaiting = (AnimationDrawable) imgAnimation.getDrawable();
                animWaiting.start();
                btnRetry.setVisibility(View.GONE);
                btnLineConnect.setVisibility(View.GONE);
...
//                                LocalInfo.getInstance().setWifiPassword(mac, wifiPassword);
            ...
            case STATUS_ADD_CAMERA_SUCCESS:
                ...
                if (bX1orX2) {
                    imgAnimation.setImageResource(com.videogo.open.R.drawable.success_img);
                } else {
                    imgAnimation.setImageResource(com.videogo.open.R.drawable.success);
                }
                // DeviceModel.A1
    ...
    private void addCameraFailed(int errorStep, int errorCode) {
        ...
        switch (errorStep) {
            case ERROR_WIFI_CONNECT:
                ...
                // 来源 设备切换wifi
                btnLineConnect.setText(com.videogo.open.R.string.ez_auto_wifi_line_connect);
                imgAnimation.setImageResource(com.videogo.open.R.drawable.failure_wifi);
                tvStatus.setText(com.videogo.open.R.string.ez_auto_wifi_connecting_failed);
                helpTop.setVisibility(View.VISIBLE);
                help.setVisibility(View.VISIBLE);
                // stopBonjourOnThread();
                recordConfigTimeAndError();
            ...
            case ERROR_REGIST:
                ...
                btnRetry.setVisibility(View.VISIBLE);
                btnLineConnect.setVisibility(View.GONE);
                imgAnimation.setImageResource(com.videogo.open.R.drawable.failure_server);
                tvStatus.setText(com.videogo.open.R.string.auto_wifi_register_failed);
                recordConfigTimeAndError();
                break;
            case ERROR_ADD_CAMERA:
                ...
                btnRetry.setVisibility(View.VISIBLE);
                btnLineConnect.setVisibility(View.GONE);
                imgAnimation.setImageResource(com.videogo.open.R.drawable.failure_account);
                if (errorCode == EZOpenSDKError.ERROR_WEB_DEVICE_EXCEPTION) {
                    // 设备异常
                    tvStatus.setText(getString(com.videogo.open.R.string.auto_wifi_add_device_failed) + "("
                            + getString(com.videogo.open.R.string.device_error) + ")");
                } else if (errorCode == EZOpenSDKError.ERROR_WEB_DEVICE_ADD_OWN_AGAIN) {
                    // 设备已被自己添加
                    // showToast(R.string.query_camera_fail_repeat_error);
                    tvStatus.setText(getString(com.videogo.open.R.string.auto_wifi_add_device_failed2) + "("
                            + getString(com.videogo.open.R.string.auto_wifi_device_you_added_already) + ")");
                    btnRetry.setVisibility(View.GONE);
                    btnFinish.setVisibility(View.VISIBLE);
                    ...
                    // 设备已经添加
                    tvStatus.setText(getString(com.videogo.open.R.string.auto_wifi_add_device_failed2) + "("
                            + getString(com.videogo.open.R.string.auto_wifi_device_added_already) + ")");
                    btnRetry.setVisibility(View.GONE);
                    btnFinish.setVisibility(View.VISIBLE);
                } else if (errorCode == EZOpenSDKError.ERROR_WEB_NET_EXCEPTION) {
                    // 网络异常
                    tvStatus.setText(getString(com.videogo.open.R.string.auto_wifi_add_device_failed2) + "("
                            + getString(com.videogo.open.R.string.network_exception) + ")");
                } else if (errorCode == EZOpenSDKError.ERROR_WEB_DIVICE_NOT_ONLINE) {
                    // 设备不在线
                    tvStatus.setText(com.videogo.open.R.string.add_device_failed_not_online);
                } else if (errorCode == EZOpenSDKError.ERROR_WEB_VERIFY_CODE_ERROR) {
                    // 验证码错误
                    tvStatus.setText(getString(com.videogo.open.R.string.auto_wifi_add_device_failed2) + "("
                            + getString(com.videogo.open.R.string.verify_code_error) + ")");
                } else if (errorCode == EZOpenSDKError.ERROR_WEB_DEVICE_NOTEXIT) {
                    // 设备不存在
                    tvStatus.setText(com.videogo.open.R.string.auto_wifi_device_not_exist);
                } else if (errorCode == EZOpenSDKError.ERROR_WEB_QUERY_CAMERA_REPEAT_ERROR) {
                    // 设备已被其他人添加
                    tvStatus.setText(com.videogo.open.R.string.auto_wifi_device_added_by_others);
                    btnRetry.setVisibility(View.GONE);
                    btnFinish.setVisibility(View.VISIBLE);
                } else if (errorCode == EZOpenSDKError.ERROR_WEB_DIVICE_OFFLINE_NOT_ADD) {
                    // 设备不在线 未添加
                    tvStatus.setText(com.videogo.open.R.string.ez_add_device_failed_not_online);
                }else if (errorCode > 0) {
                    tvStatus.setText(getErrorTip(com.videogo.open.R.string.auto_wifi_add_device_failed, errorCode));
                } else {
                    tvStatus.setText(com.videogo.open.R.string.auto_wifi_add_device_failed);
                }
                recordConfigTimeAndError();
                break;
            default:
...
//        }
    ...
    private void addQueryCameraAddVerifyCode() {
        // 本地网络检测
        if (!ConnectionDetector.isNetworkAvailable(this)) {
            showToast(com.videogo.open.R.string.add_camera_fail_network_exception);
            return;
        }
        new Thread() {
            public void run() {
...
*/
    ...
    public void openCloudFailed(int arg1) {
        ...
        new AlertDialog.Builder(this).setTitle(com.videogo.open.R.string.enable_cloud_fause)
                .setMessage(com.videogo.open.R.string.enable_cloud_fause_retry)
                ...
                }).setPositiveButton(com.videogo.open.R.string.not_now, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        closeActivity();
    ...
    private void showInputCameraVerifyCodeDlg() {
        ...
        final View passwordErrorLayout = factory.inflate(com.videogo.open.R.layout.verifycode_layout, null);
        ...
        message1.setText(com.videogo.open.R.string.realplay_verifycode_error_message0);
    ...
    private void showInputCameraPswDlg() {
        ...
        // 使用布局中的视图创建AlertDialog
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(com.videogo.open.R.string.serial_add_password_error_title);
        builder.setView(passwordErrorLayout);
        builder.setPositiveButton(com.videogo.open.R.string.cancel, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                finish();
