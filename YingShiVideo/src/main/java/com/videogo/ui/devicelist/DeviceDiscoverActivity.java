...
public class DeviceDiscoverActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.videogo.open.R.layout.device_discover_page);
        init();
        findViews();
        startBonjour();
    }
    ...
    private void findViews() {
        ...
        mTitleBar.setTitle(com.videogo.open.R.string.auto_wifi_title_add_device);
        ...
        mDiscoverTv = (TextView) findViewById(com.videogo.open.R.id.discover_tv);
        mRetryBtn = (Button) findViewById(com.videogo.open.R.id.retry_btn);
        mDeviceDiscoverListView = (ListView) findViewById(com.videogo.open.R.id.discover_list_lv);
    ...
    private void startBonjour() {
        mDiscoverTv.setText(com.videogo.open.R.string.discovering_device);
    ...
    private void startReportBonjour() {
        ...
        startOvertimeTimer(OVERTIME_CONNECT_WIFI_REGIST, new Runnable() {
            public void run() {
                stopBonjour();
                mDiscoverTv.setText(com.videogo.open.R.string.discover_device_done);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == com.videogo.open.R.id.retry_btn) {
            startBonjour();

        } else if (i == com.videogo.open.R.id.add_btn) {
            openAddDeviceDialog((String) v.getTag());

        } else if (i == com.videogo.open.R.id.local_realplay_btn) {
    ...
    private class AddDeviceTask extends AsyncTask<SecurityEditText, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result != null && result) {
                Utils.showToast(DeviceDiscoverActivity.this, com.videogo.open.R.string.add_device_success);
            } else {
                Utils.showToast(DeviceDiscoverActivity.this, com.videogo.open.R.string.add_device_fail, mErrorCode);
            }
        }
    }
}
