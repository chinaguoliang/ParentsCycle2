    ...
    private class AddDeviceTask extends AsyncTask<SecurityEditText, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result != null && result) {
                Utils.showToast(EZDevDiscActivity.this, com.videogo.open.R.string.add_device_success);
            } else {
                Utils.showToast(EZDevDiscActivity.this, com.videogo.open.R.string.add_device_fail, mErrorCode);
            }
        }
    }
}
