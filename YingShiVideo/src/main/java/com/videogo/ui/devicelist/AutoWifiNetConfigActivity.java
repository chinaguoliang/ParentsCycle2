...
public class AutoWifiNetConfigActivity extends RootActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.videogo.open.R.layout.auto_wifi_net_config);
        init();
        initTitleBar();
        findViews();
        initUI();
    ...
    private void initTitleBar() {
        ...
        tvTitle = mTitleBar.setTitle(com.videogo.open.R.string.auto_wifi_cer_config_title1);
    ...
    private void showWifiRequiredDialog() {
        ...
        new AlertDialog.Builder(this).setTitle(com.videogo.open.R.string.auto_wifi_dialog_title_wifi_required)
                .setMessage(com.videogo.open.R.string.please_open_wifi_network)
                .setNegativeButton(com.videogo.open.R.string.auto_wifi_dialog_btn_wifi, new DialogInterface.OnClickListener() {
                    @Override
    ...
    protected void onResume() {
        ...
        if (ConnectionDetector.getConnectionType(this) != ConnectionDetector.WIFI) {
            tvSSID.setText(com.videogo.open.R.string.unknow_ssid);
    ...
    private void findViews() {
        ...
        tvSSID = (TextView) findViewById(com.videogo.open.R.id.tvSSID);
        edtPassword = (EditText) findViewById(com.videogo.open.R.id.edtPassword);
    }
    ...
    private void initUI() {
        ...
        if (isFromDeviceSetting) {
            tvTitle.setText(com.videogo.open.R.string.auto_wifi_cer_config_title1);
        } else {
            tvTitle.setText(com.videogo.open.R.string.auto_wifi_cer_config_title2);
        }
        tvSSID.setText(BaseUtil.getWifiSSID(this));
