...
public class SeriesNumSearchActivity extends RootActivity implements OnClickListener/*, OnAuthListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.videogo.open.R.layout.add_camera_by_series_number_page);
    ...
    private void initTitleBar() {
        ...
        mTitle = mTitleBar.setTitle(com.videogo.open.R.string.result_txt);
...
//        mTriggerHelper = new UnbindDeviceTriggerHelper(this, R.id.unbind_button);
    ...
    private void findViews() {
        mSeriesNumberEt = (EditText) findViewById(com.videogo.open.R.id.seriesNumberEt);

        if (mSerialNoStr != null) {
            mSeriesNumberEt.setText(mSerialNoStr);
        }
        mInputLinearlayout = findViewById(com.videogo.open.R.id.inputLinearlayout);
        mQueryingCameraRyt = findViewById(com.videogo.open.R.id.queryingCameraRyt);
        errorPage = findViewById(com.videogo.open.R.id.errorPage);
        mCameraListLy = findViewById(com.videogo.open.R.id.cameraListLy);

        mDeviceIcon = (ImageView) findViewById(com.videogo.open.R.id.deviceIcon);
        mDeviceName = (TextView) findViewById(com.videogo.open.R.id.deviceName);
        mTvStatus = (TextView) findViewById(com.videogo.open.R.id.tvStatus);
        mAddButton = (Button) findViewById(com.videogo.open.R.id.addBtn);
        mBtnNext = findViewById(com.videogo.open.R.id.btnNext);
        mActivateHint = findViewById(com.videogo.open.R.id.activateHint);

        mFailedMsg = (TextView) findViewById(com.videogo.open.R.id.failedMsg);

        mConnectTip = (TextView) findViewById(com.videogo.open.R.id.connectTip);

        ImageView searchAnim = (ImageView) findViewById(com.videogo.open.R.id.searchAnim);
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == com.videogo.open.R.id.searchBtn) {// 只有手动搜索点击的时候才会，清空验证码，二维码过来的不会清空
        ...
        } else if (i == com.videogo.open.R.id.addBtn) {
            addQueryCamera();

        } else if (i == com.videogo.open.R.id.btnNext) {
            Intent intent;
            // demo代码这里只示范wifi配置
        ...
        } else if (i == com.videogo.open.R.id.myRetry) {
            searchCameraBySN();

        } else if (i == com.videogo.open.R.id.activateHint) {
...
//                    ActivateActivity.launch(this, mSerialNoStr, mVerifyCode, mType, mDeviceType);
    ...
    private void showWifiRequiredDialog() {
        new AlertDialog.Builder(this).setTitle(com.videogo.open.R.string.auto_wifi_dialog_title_wifi_required)
                .setMessage(com.videogo.open.R.string.please_open_wifi_network_sadp)
                .setNegativeButton(com.videogo.open.R.string.connect_wlan, new DialogInterface.OnClickListener() {
                    @Override
                ...
                }).setPositiveButton(com.videogo.open.R.string.cancel, new DialogInterface.OnClickListener() {
                    @Override
...
//                mTriggerHelper.onNewIntent(intent);
    ...
    public void searchCameraBySN() {
        ...
        if (!ConnectionDetector.isNetworkAvailable(SeriesNumSearchActivity.this)) {
            showErrorPage(com.videogo.open.R.string.query_camera_fail_network_exception, 0);
            return;
        }
    ...
    private void handleAddCameraFail(int errCode) {
        ...
        switch (errCode) {
            ...
            case EZOpenSDKError.VIDEOGONETSDK_SERVER_EXCEPTION:
                showToast(com.videogo.open.R.string.add_camera_fail_server_exception);
                break;
            case EZOpenSDKError.ERROR_WEB_DIVICE_VERIFY_CODE_ERROR:
                mVerifyCode = null;
                {
                    ...
                    args.putString(BUNDE_DIALOG_TIP, getString(com.videogo.open.R.string.added_camera_verycode_fail_title_txt));
            ...
            case EZOpenSDKError.ERROR_WEB_DIVICE_SO_TIMEOUT:
                showToast(com.videogo.open.R.string.device_so_timeout);
                break;
            case EZOpenSDKError.ERROR_WEB_DEVICE_NO_OUT_LIMIT_ERROR:
                // 处理设备添加数目达到上限
                showToast(com.videogo.open.R.string.device_no_out_limit);
                break;
            case EZOpenSDKError.ERROR_WEB_DEVICE_NOTEXIT:
                showToast(com.videogo.open.R.string.query_camera_fail_not_exit);
                break;
            ...
            case 120010:
                ...
                break;
            default:
                showToast(com.videogo.open.R.string.add_camera_fail_server_exception, errCode);
    ...
    private void handleLocalValidateCameraPswFail(int errCode) {
        switch (errCode) {
            case ExtraException.CAMERA_PASSWORD_IS_NULL:
                showToast(com.videogo.open.R.string.camera_password_is_null);
                break;
            default:
                showToast(com.videogo.open.R.string.camera_password_error, errCode);
    ...
    private void handleLocalValidateSerialNoFail(int errCode) {
        switch (errCode) {
            case ExtraException.SERIALNO_IS_NULL:
                showToast(com.videogo.open.R.string.serial_number_is_null);
                break;
            case ExtraException.SERIALNO_IS_ILLEGAL:
                showToast(com.videogo.open.R.string.serial_number_put_the_right_no);
                break;
            default:
                showToast(com.videogo.open.R.string.serial_number_error, errCode);
...
//        mDeviceIcon.setImageResource(getDeviceIcon(""));
    ...
    private void handleQueryCameraFail(final int errCode) {
        ...
        switch (errCode) {
            ...
            case EZOpenSDKError.VIDEOGONETSDK_DIVICE_UNSUPPORT:
                showErrorPage(com.videogo.open.R.string.seek_camera_fail_device_not_support_shipin7, 0);
                break;
            case EZOpenSDKError.VIDEOGONETSDK_NETWORD_EXCEPTION:
                showErrorPage(com.videogo.open.R.string.query_camera_fail_network_exception, 0);
                break;
            ...
            case EZOpenSDKError.VIDEOGONETSDK_SERVER_EXCEPTION:
                showErrorPage(com.videogo.open.R.string.query_camera_fail_server_exception, 0);
                break;
            case EZOpenSDKError.VIDEOGONETSDK_SESSION_ERROR:
                ActivityUtils.handleSessionException(SeriesNumSearchActivity.this);
                break;
            case EZOpenSDKError.ERROR_WEB_HARDWARE_SIGNATURE_ERROR:
                showErrorPage(com.videogo.open.R.string.check_feature_code_fail, errCode);
                //ActivityUtils.handleHardwareError(SeriesNumSearchActivity.this, null);
                break;
            case EZOpenSDKError.VIDEOGONETSDK_INPUTPARAM_ERROR:
                showErrorPage(com.videogo.open.R.string.query_camera_fail_network_exception_or_server_exception, 0);
                break;
            ...
            case EZOpenSDKError.ERROR_WEB_DIVICE_OFFLINE_BUT_ADD:   //设备不在线，已被别人添加
                showToast(com.videogo.open.R.string.query_camera_fail_repeat_error);
                showCameraList();

                mTvStatus.setVisibility(View.VISIBLE);
                mTvStatus.setText(com.videogo.open.R.string.auto_wifi_device_you_added_already);
                mTvStatus.setTextColor(getResources().getColor(com.videogo.open.R.color.common_text));
                mBtnNext.setVisibility(View.GONE);
            ...
            case EZOpenSDKError.ERROR_WEB_DIVICE_OFFLINE_NOT_ADD:
                ...
                break;
            default:
                showErrorPage(com.videogo.open.R.string.query_camera_fail, errCode);
    ...
    public void showUnbind() {
        ...
        mTvStatus.setVisibility(View.VISIBLE);
        mTvStatus.setTextColor(getResources().getColor(com.videogo.open.R.color.common_text));
        mTvStatus.setText(com.videogo.open.R.string.scan_device_add_by_others);
        mBtnNext.setVisibility(View.GONE);
        mAddButton.setVisibility(View.GONE);
        mConnectTip.setVisibility(View.GONE);
    ...
    private void showInputSerialNo() {
        ...
        mTitle.setText(com.videogo.open.R.string.serial_input_text);
    ...
    private void showQueryingCamera() {
        ...
        errorPage.setVisibility(View.GONE);
        mCameraListLy.setVisibility(View.GONE);
        mTitle.setText(com.videogo.open.R.string.scan_device_search);
    ...
    private void showCameraList() {
        ...
        mTitle.setText(com.videogo.open.R.string.result_txt);
        mActivateHint.setVisibility(View.GONE);
        errorPage.setVisibility(View.GONE);
    ...
    private void showWifiConfig() {
        ...
        mAddButton.setVisibility(View.GONE);
        mTvStatus.setTextColor(getResources().getColor(com.videogo.open.R.color.scan_yellow));
        mTvStatus.setText(com.videogo.open.R.string.scan_network_unavailible);
    }
