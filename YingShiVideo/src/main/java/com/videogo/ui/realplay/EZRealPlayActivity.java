...
public class EZRealPlayActivity extends Activity implements OnClickListener, SurfaceHolder.Callback,
    ...
    protected void onResume() {
        ...
        if (mCameraInfo != null && mCameraInfo.getOnlineStatus() != 1) {
            ...
            setRealPlayFailUI(getString(com.videogo.open.R.string.realplay_fail_device_not_exist));
        } else {
    ...
    protected void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.jgkj.parentscycle/http/host/path")
        );
    ...
    private void initTitleBar() {
        mPortraitTitleBar = (TitleBar) findViewById(com.videogo.open.R.id.title_bar_portrait);
        ...
        mLandscapeTitleBar = (TitleBar) findViewById(com.videogo.open.R.id.title_bar_landscape);
        mLandscapeTitleBar.setStyle(Color.rgb(0xff, 0xff, 0xff), getResources().getDrawable(com.videogo.open.R.color.dark_bg_70p),
    ...
    private void initRealPlayPageLy() {
        mRealPlayPageLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_page_ly);
        /** 测量状态栏高度 **/
    ...
    private void initView() {
        setContentView(com.videogo.open.R.layout.ez_realplay_page);
        // 保持屏幕常亮
        ...
        mRealPlayPlayRl = (RelativeLayout) findViewById(com.videogo.open.R.id.realplay_play_rl);
        mRealPlaySv = (SurfaceView) findViewById(com.videogo.open.R.id.realplay_sv);
        ...
        mRealPlayPtzDirectionIv = (ImageView) findViewById(com.videogo.open.R.id.realplay_ptz_direction_iv);

        mRealPlayPromptRl = (RelativeLayout) findViewById(com.videogo.open.R.id.realplay_prompt_rl);
        mRealPlayControlRl = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_control_rl);
        mRealPlayBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_play_btn);
        mRealPlaySoundBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_sound_btn);
        //        mRealPlayFlowTv = (TextView) findViewById(R.id.realplay_flow_tv);
        //        mRealPlayFlowTv.setText("0k/s 0MB");

        mRealPlayCaptureRl = (RelativeLayout) findViewById(com.videogo.open.R.id.realplay_capture_rl);
        mRealPlayCaptureRlLp = (LayoutParams) mRealPlayCaptureRl.getLayoutParams();
        mRealPlayCaptureIv = (ImageView) findViewById(com.videogo.open.R.id.realplay_capture_iv);
        mRealPlayCaptureWatermarkIv = (ImageView) findViewById(com.videogo.open.R.id.realplay_capture_watermark_iv);
        mRealPlayRecordLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_record_ly);
        mRealPlayRecordIv = (ImageView) findViewById(com.videogo.open.R.id.realplay_record_iv);
        mRealPlayRecordTv = (TextView) findViewById(com.videogo.open.R.id.realplay_record_tv);

        mRealPlayQualityBtn = (Button) findViewById(com.videogo.open.R.id.realplay_quality_btn);

        mRealPlayFullFlowLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_full_flow_ly);
        mRealPlayFullRateTv = (TextView) findViewById(com.videogo.open.R.id.realplay_full_rate_tv);
        mRealPlayFullFlowTv = (TextView) findViewById(com.videogo.open.R.id.realplay_full_flow_tv);
        mRealPlayRatioTv = (TextView) findViewById(com.videogo.open.R.id.realplay_ratio_tv);
        mRealPlayFullRateTv.setText("0k/s");
        mRealPlayFullFlowTv.setText("0MB");

        mFullscreenButton = (CheckTextButton) findViewById(com.videogo.open.R.id.fullscreen_button);
        mFullscreenFullButton = (CheckTextButton) findViewById(com.videogo.open.R.id.fullscreen_full_button);
        ...
        if (mRtspUrl == null) {
            ...
            mRealPlayPlayRl.setLayoutParams(realPlayPlayRlLp);
            mRealPlayPlayRl.setBackgroundColor(getResources().getColor(com.videogo.open.R.color.common_bg));
        }
        ...
        if (command != -1 && errorCode == 0) {
            ...
            switch (command) {
                case RealPlayStatus.PTZ_LEFT:
                    mRealPlayPtzDirectionIv.setBackgroundResource(com.videogo.open.R.drawable.left_twinkle);
                    params.addRule(RelativeLayout.CENTER_VERTICAL);
                    params.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
                    mRealPlayPtzDirectionIv.setLayoutParams(params);
                    break;
                case RealPlayStatus.PTZ_RIGHT:
                    mRealPlayPtzDirectionIv.setBackgroundResource(com.videogo.open.R.drawable.right_twinkle);
                    params.addRule(RelativeLayout.CENTER_VERTICAL);
                    params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
                    mRealPlayPtzDirectionIv.setLayoutParams(params);
                    break;
                case RealPlayStatus.PTZ_UP:
                    mRealPlayPtzDirectionIv.setBackgroundResource(com.videogo.open.R.drawable.up_twinkle);
                    params.addRule(RelativeLayout.CENTER_HORIZONTAL);
                    params.addRule(RelativeLayout.ALIGN_PARENT_TOP);
                    mRealPlayPtzDirectionIv.setLayoutParams(params);
                    break;
                case RealPlayStatus.PTZ_DOWN:
                    mRealPlayPtzDirectionIv.setBackgroundResource(com.videogo.open.R.drawable.down_twinkle);
                    params.addRule(RelativeLayout.CENTER_HORIZONTAL);
                    params.addRule(RelativeLayout.ALIGN_BOTTOM, com.videogo.open.R.id.realplay_sv);
                    mRealPlayPtzDirectionIv.setLayoutParams(params);
                    break;
                default:
                    break;
            ...
            switch (errorCode) {
                case ErrorCode.ERROR_CAS_PTZ_ROTATION_LEFT_LIMIT_FAILED:
                    ...
                    mRealPlayPtzDirectionIv.setBackgroundResource(com.videogo.open.R.drawable.ptz_left_limit);
                    params.addRule(RelativeLayout.CENTER_VERTICAL);
                    params.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
                    mRealPlayPtzDirectionIv.setLayoutParams(params);
                    break;
                case ErrorCode.ERROR_CAS_PTZ_ROTATION_RIGHT_LIMIT_FAILED:
                    params = new LayoutParams(LayoutParams.WRAP_CONTENT, svParams.height);
                    mRealPlayPtzDirectionIv.setBackgroundResource(com.videogo.open.R.drawable.ptz_right_limit);
                    params.addRule(RelativeLayout.CENTER_VERTICAL);
                    params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
                    mRealPlayPtzDirectionIv.setLayoutParams(params);
                    break;
                case ErrorCode.ERROR_CAS_PTZ_ROTATION_UP_LIMIT_FAILED:
                    ...
                    mRealPlayPtzDirectionIv.setBackgroundResource(com.videogo.open.R.drawable.ptz_top_limit);
                    params.addRule(RelativeLayout.CENTER_HORIZONTAL);
                    params.addRule(RelativeLayout.ALIGN_PARENT_TOP);
                    mRealPlayPtzDirectionIv.setLayoutParams(params);
                    break;
                case ErrorCode.ERROR_CAS_PTZ_ROTATION_DOWN_LIMIT_FAILED:
                    params = new LayoutParams(svParams.width, LayoutParams.WRAP_CONTENT);
                    mRealPlayPtzDirectionIv.setBackgroundResource(com.videogo.open.R.drawable.ptz_bottom_limit);
                    params.addRule(RelativeLayout.CENTER_HORIZONTAL);
                    params.addRule(RelativeLayout.ALIGN_BOTTOM, com.videogo.open.R.id.realplay_sv);
                    mRealPlayPtzDirectionIv.setLayoutParams(params);
                    break;
    ...
    private void initUI() {
        ...
        if (mCameraInfo != null) {
            ...
            if (mLocalInfo.isSoundOpen()) {
                mRealPlaySoundBtn.setBackgroundResource(com.videogo.open.R.drawable.ezopen_vertical_preview_sound_selector);
                mRealPlayFullSoundBtn.setBackgroundResource(com.videogo.open.R.drawable.play_full_soundon_btn_selector);
            } else {
                mRealPlaySoundBtn.setBackgroundResource(com.videogo.open.R.drawable.ezopen_vertical_preview_sound_off_selector);
                mRealPlayFullSoundBtn.setBackgroundResource(com.videogo.open.R.drawable.play_full_soundoff_btn_selector);
            }
    ...
    private void initOperateBarUI(boolean bigScreen) {
        ...
        if (bigScreen) {
            mRealPlayOperateBar = (HorizontalScrollView) findViewById(com.videogo.open.R.id.ezopen_realplay_operate_bar2);
            findViewById(com.videogo.open.R.id.ezopen_realplay_operate_bar).setVisibility(View.GONE);

            mRealPlayPtzBtnLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_ptz_btn_ly2);
            mRealPlayTalkBtnLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_talk_btn_ly2);
            mRealPlaySslBtnLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_ssl_btn_ly2);
            mRealPlayCaptureBtnLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_previously_btn_ly2);
            mRealPlayRecordContainerLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_video_container_ly2);

            mRealPlayTalkBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_talk_btn2);
            mRealPlaySslBtn = (Button) findViewById(com.videogo.open.R.id.realplay_ssl_btn2);
            mRealPlayPrivacyBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_privacy_btn2);
            mRealPlayCaptureBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_previously_btn2);
            mRealPlayRecordContainer = findViewById(com.videogo.open.R.id.realplay_video_container2);
            mRealPlayRecordBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_video_btn2);
            mRealPlayRecordStartBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_video_start_btn2);
            mRealPlayPtzBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_ptz_btn2);
        } else {
            mRealPlayOperateBar = (HorizontalScrollView) findViewById(com.videogo.open.R.id.ezopen_realplay_operate_bar);
            findViewById(com.videogo.open.R.id.ezopen_realplay_operate_bar2).setVisibility(View.GONE);

            mRealPlayPtzBtnLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_ptz_btn_ly);
            mRealPlayTalkBtnLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_talk_btn_ly);
            mRealPlaySslBtnLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_ssl_btn_ly);
            mRealPlayCaptureBtnLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_previously_btn_ly);
            mRealPlayRecordContainerLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_video_container_ly);

            mRealPlayTalkBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_talk_btn);
            mRealPlaySslBtn = (Button) findViewById(com.videogo.open.R.id.realplay_ssl_btn);
            mRealPlayPrivacyBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_privacy_btn);
            mRealPlayCaptureBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_previously_btn);
            mRealPlayRecordContainer = findViewById(com.videogo.open.R.id.realplay_video_container);
            mRealPlayRecordBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_video_btn);
    ...
    private void initFullOperateBarUI() {
        mRealPlayFullOperateBar = (RelativeLayout) findViewById(com.videogo.open.R.id.realplay_full_operate_bar);
        mRealPlayFullPlayBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_play_btn);
        mRealPlayFullSoundBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_sound_btn);
        mRealPlayFullTalkBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_talk_btn);
        mRealPlayFullCaptureBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_previously_btn);
        mRealPlayFullPtzBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_ptz_btn);
        mRealPlayFullRecordContainer = findViewById(com.videogo.open.R.id.realplay_full_video_container);
        mRealPlayFullRecordBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_video_btn);
        mRealPlayFullRecordStartBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_video_start_btn);
        mRealPlayFullOperateBar.setOnTouchListener(this);

        mRealPlayFullPtzAnimBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_ptz_anim_btn);
        mRealPlayFullPtzPromptIv = (ImageView) findViewById(com.videogo.open.R.id.realplay_full_ptz_prompt_iv);

        mRealPlayFullTalkAnimBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_talk_anim_btn);

        mRealPlayFullAnimBtn = (ImageButton) findViewById(com.videogo.open.R.id.realplay_full_anim_btn);
    }
    ...
    private void setVideoLevel() {
        ...
        if (mCurrentQulityMode.getVideoLevel() == EZVideoLevel.VIDEO_LEVEL_FLUNET.getVideoLevel()) {
            mRealPlayQualityBtn.setText(com.videogo.open.R.string.quality_flunet);
        } else if (mCurrentQulityMode.getVideoLevel() == EZVideoLevel.VIDEO_LEVEL_BALANCED.getVideoLevel()) {
            mRealPlayQualityBtn.setText(com.videogo.open.R.string.quality_balanced);
        } else if (mCurrentQulityMode.getVideoLevel() == EZVideoLevel.VIDEO_LEVEL_HD.getVideoLevel()) {
            mRealPlayQualityBtn.setText(com.videogo.open.R.string. quality_hd);
        }
    }
    ...
    private void updateOperatorUI() {
        if (mOrientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            if (mRtspUrl == null) {
                mRealPlayPageLy.setBackgroundColor(getResources().getColor(com.videogo.open.R.color.common_bg));
                mRealPlayOperateBar.setVisibility(View.VISIBLE);
            ...
            if (mRtspUrl == null) {
                mRealPlayOperateBar.setVisibility(View.GONE);
                mRealPlayPageLy.setBackgroundColor(getResources().getColor(com.videogo.open.R.color.black_bg));
                mRealPlayFullOperateBar.setVisibility(View.GONE);
                if (!mIsOnTalk && !mIsOnPtz) {
                    mFullscreenFullButton.setVisibility(View.GONE);
                }
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == com.videogo.open.R.id.realplay_play_btn || i == com.videogo.open.R.id.realplay_full_play_btn || i == com.videogo.open.R.id.realplay_play_iv) {
            if (mStatus != RealPlayStatus.STATUS_STOP) {
                stopRealPlay();
                setRealPlayStopUI();
            } else {
        ...
        } else if (i == com.videogo.open.R.id.realplay_previously_btn || i == com.videogo.open.R.id.realplay_previously_btn2 || i == com.videogo.open.R.id.realplay_full_previously_btn) {
            onCapturePicBtnClick();

        } else if (i == com.videogo.open.R.id.realplay_capture_rl) {
            onCaptureRlClick();

        } else if (i == com.videogo.open.R.id.realplay_video_btn || i == com.videogo.open.R.id.realplay_video_start_btn || i == com.videogo.open.R.id.realplay_video_btn2 || i == com.videogo.open.R.id.realplay_video_start_btn2 || i == com.videogo.open.R.id.realplay_full_video_btn || i == com.videogo.open.R.id.realplay_full_video_start_btn) {
            onRecordBtnClick();

        } else if (i == com.videogo.open.R.id.realplay_talk_btn || i == com.videogo.open.R.id.realplay_talk_btn2 || i == com.videogo.open.R.id.realplay_full_talk_btn) {
            startVoiceTalk();

        } else if (i == com.videogo.open.R.id.realplay_quality_btn) {
            openQualityPopupWindow(mRealPlayQualityBtn);

        } else if (i == com.videogo.open.R.id.realplay_ptz_btn || i == com.videogo.open.R.id.realplay_ptz_btn2) {
            openPtzPopupWindow(mRealPlayPageLy);

        } else if (i == com.videogo.open.R.id.realplay_full_ptz_btn) {
            setFullPtzStartUI(true);

        } else if (i == com.videogo.open.R.id.realplay_full_ptz_anim_btn) {
            setFullPtzStopUI(true);

        } else if (i == com.videogo.open.R.id.realplay_sound_btn || i == com.videogo.open.R.id.realplay_full_sound_btn) {
            onSoundBtnClick();

        } else if (i == com.videogo.open.R.id.realplay_full_talk_anim_btn) {
    ...
    private void setFullPtzStartUI(boolean startAnim) {
        ...
        if (mLocalInfo.getPtzPromptCount() < 3) {
            mRealPlayFullPtzPromptIv.setBackgroundResource(com.videogo.open.R.drawable.ptz_prompt);
        ...
        if (startAnim) {
            mRealPlayFullAnimBtn.setBackgroundResource(com.videogo.open.R.drawable.yuntai_pressed);
    ...
    private void startVoiceTalk() {
        ...
        Utils.showToast(this, com.videogo.open.R.string.start_voice_talk);
        mRealPlayTalkBtn.setEnabled(false);
        mRealPlayFullTalkBtn.setEnabled(false);
        mRealPlayFullTalkAnimBtn.setEnabled(false);
        if (mOrientation == Configuration.ORIENTATION_LANDSCAPE) {
            mRealPlayFullAnimBtn.setBackgroundResource(com.videogo.open.R.drawable.speech_1);
            mRealPlayFullTalkBtn.getLocationInWindow(mStartXy);
            mEndXy[0] = Utils.dip2px(this, 20);
            mEndXy[1] = mStartXy[1];
            startFullBtnAnim(mRealPlayFullAnimBtn, mStartXy, mEndXy, new AnimationListener() {
                ...
                @Override
                public void onAnimationEnd(Animation animation) {
                    Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.realplay_full_talk_start_tip);
                    mRealPlayFullTalkAnimBtn.setVisibility(View.VISIBLE);
                    mRealPlayFullAnimBtn.setVisibility(View.GONE);
                    onRealPlaySvClick();
                    //                    mFullscreenFullButton.setVisibility(View.VISIBLE);
    ...
    private OnClickListener mOnPopWndClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            int i = v.getId();
            if (i == com.videogo.open.R.id.quality_hd_btn) {
                setQualityMode(EZVideoLevel.VIDEO_LEVEL_HD);

            } else if (i == com.videogo.open.R.id.quality_balanced_btn) {
                setQualityMode(EZVideoLevel.VIDEO_LEVEL_BALANCED);

            } else if (i == com.videogo.open.R.id.quality_flunet_btn) {
                setQualityMode(EZVideoLevel.VIDEO_LEVEL_FLUNET);

            } else if (i == com.videogo.open.R.id.ptz_close_btn) {
                closePtzPopupWindow();

            } else if (i == com.videogo.open.R.id.ptz_flip_btn) {//                    setPtzFlip();

            } else if (i == com.videogo.open.R.id.talkback_close_btn) {
                closeTalkPopupWindow(true, false);
    ...
    private OnTouchListener mOnTouchListener = new OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionevent) {
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                int i = view.getId();
                if (i == com.videogo.open.R.id.talkback_control_btn) {
                    mTalkRingView.setVisibility(View.VISIBLE);
                    mEZPlayer.setVoiceTalkStatus(true);

                } else if (i == com.videogo.open.R.id.ptz_top_btn) {
                    mPtzControlLy.setBackgroundResource(com.videogo.open.R.drawable.ptz_up_sel);
                ...
                } else if (i == com.videogo.open.R.id.ptz_bottom_btn) {
                    mPtzControlLy.setBackgroundResource(com.videogo.open.R.drawable.ptz_bottom_sel);
                ...
                } else if (i == com.videogo.open.R.id.ptz_left_btn) {
                    mPtzControlLy.setBackgroundResource(com.videogo.open.R.drawable.ptz_left_sel);
                ...
                } else if (i == com.videogo.open.R.id.ptz_right_btn) {
                    mPtzControlLy.setBackgroundResource(com.videogo.open.R.drawable.ptz_right_sel);
                ...
                if (i == com.videogo.open.R.id.talkback_control_btn) {
                    ...
                    mPtzControlLy.setBackgroundResource(com.videogo.open.R.drawable.ptz_bg);
                    ptz_result = mEZOpenSDK.controlPTZ(mCameraInfo.getCameraId(), EZPTZCommand.EZPTZCommandUp,
    ...
    private void setQualityMode(final EZVideoLevel mode) {
        ...
        if (!ConnectionDetector.isNetworkAvailable(EZRealPlayActivity.this)) {
            // 提示没有连接网络
            Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.realplay_set_fail_network);
            return;
        }

        if (mEZPlayer != null) {
            mWaitDialog.setWaitText(this.getString(com.videogo.open.R.string.setting_video_level));
            mWaitDialog.show();
    ...
    private void openTalkPopupWindow(View parent, boolean showAnimation) {
        ...
        ViewGroup layoutView = (ViewGroup) layoutInflater.inflate(com.videogo.open.R.layout.realplay_talkback_wnd, null, true);
        ...
        ImageButton talkbackCloseBtn = (ImageButton) layoutView.findViewById(com.videogo.open.R.id.talkback_close_btn);
        talkbackCloseBtn.setOnClickListener(mOnPopWndClickListener);
        mTalkRingView = (RingView) layoutView.findViewById(com.videogo.open.R.id.talkback_rv);
        mTalkBackControlBtn = (Button) layoutView.findViewById(com.videogo.open.R.id.talkback_control_btn);
        ...
        if (mDeviceInfo.isSupportTalk()/*mStub.getSupportTalk() == EZRealPlayConstants.TALK_FULL_DUPLEX*/) {
            ...
            mTalkBackControlBtn.setText(com.videogo.open.R.string.talking);
        }
        ...
        if (showAnimation) {
            mTalkPopupWindow.setAnimationStyle(com.videogo.open.R.style.popwindowUpAnim);
        }
    ...
    private void openPtzPopupWindow(View parent) {
        ...
        LayoutInflater layoutInflater = (LayoutInflater) this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ViewGroup layoutView = (ViewGroup) layoutInflater.inflate(com.videogo.open.R.layout.realplay_ptz_wnd, null, true);

        mPtzControlLy = (LinearLayout) layoutView.findViewById(com.videogo.open.R.id.ptz_control_ly);
        ImageButton ptzCloseBtn = (ImageButton) layoutView.findViewById(com.videogo.open.R.id.ptz_close_btn);
        ptzCloseBtn.setOnClickListener(mOnPopWndClickListener);
        ImageButton ptzTopBtn = (ImageButton) layoutView.findViewById(com.videogo.open.R.id.ptz_top_btn);
        ptzTopBtn.setOnTouchListener(mOnTouchListener);
        ImageButton ptzBottomBtn = (ImageButton) layoutView.findViewById(com.videogo.open.R.id.ptz_bottom_btn);
        ptzBottomBtn.setOnTouchListener(mOnTouchListener);
        ImageButton ptzLeftBtn = (ImageButton) layoutView.findViewById(com.videogo.open.R.id.ptz_left_btn);
        ptzLeftBtn.setOnTouchListener(mOnTouchListener);
        ImageButton ptzRightBtn = (ImageButton) layoutView.findViewById(com.videogo.open.R.id.ptz_right_btn);
        ptzRightBtn.setOnTouchListener(mOnTouchListener);
        ImageButton ptzFlipBtn = (ImageButton) layoutView.findViewById(com.videogo.open.R.id.ptz_flip_btn);
        ...
        mPtzPopupWindow.setAnimationStyle(com.videogo.open.R.style.popwindowUpAnim);
    ...
    private void openQualityPopupWindow(View anchor) {
        ...
        closeQualityPopupWindow();
        LayoutInflater layoutInflater = (LayoutInflater) this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ViewGroup layoutView = (ViewGroup) layoutInflater.inflate(com.videogo.open.R.layout.realplay_quality_items, null, true);

        Button qualityHdBtn = (Button) layoutView.findViewById(com.videogo.open.R.id.quality_hd_btn);
        qualityHdBtn.setOnClickListener(mOnPopWndClickListener);
        Button qualityBalancedBtn = (Button) layoutView.findViewById(com.videogo.open.R.id.quality_balanced_btn);
        qualityBalancedBtn.setOnClickListener(mOnPopWndClickListener);
        Button qualityFlunetBtn = (Button) layoutView.findViewById(com.videogo.open.R.id.quality_flunet_btn);
    ...
    private void onRecordBtnClick() {
        ...
        if (!SDCardUtil.isSDCardUseable()) {
            // 提示SD卡不可用
            Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.remoteplayback_SDCard_disable_use);
            return;
        }

        if (SDCardUtil.getSDCardRemainSize() < SDCardUtil.PIC_MIN_MEM_SPACE) {
            // 提示内存不足
            Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.remoteplayback_record_fail_for_memory);
            return;
        }
...
//            mEZPlayer.startRecord("/sdcard/video.mp4");
    ...
    private void stopRealPlayRecord() {
        ...
        Toast.makeText(EZRealPlayActivity.this, getResources().getString(com.videogo.open.R.string.already_saved_to_volume), Toast.LENGTH_SHORT).show();
    ...
    private void onCapturePicBtnClick() {
        ...
        if (SDCardUtil.getSDCardRemainSize() < SDCardUtil.PIC_MIN_MEM_SPACE) {
            // 提示内存不足
            Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.remoteplayback_capture_fail_for_memory);
            return;
        }
    ...
    private void startRealPlay() {
        ...
        if (!ConnectionDetector.isNetworkAvailable(this)) {
            // 提示没有连接网络
            setRealPlayFailUI(getString(com.videogo.open.R.string.realplay_play_fail_becauseof_network));
            return;
        }
...
//                        return;
    ...
    private void setRealPlayLoadingUI() {
        ...
        mRealPlaySv.setVisibility(View.VISIBLE);
        setStartloading();
        mRealPlayBtn.setBackgroundResource(com.videogo.open.R.drawable.play_stop_selector);
        ...
        if (mCameraInfo != null) {
            ...
            mRealPlayFullPlayBtn.setBackgroundResource(com.videogo.open.R.drawable.play_full_stop_selector);
    ...
    private void setRealPlayStopUI() {
        ...
        mRealPlayBtn.setBackgroundResource(com.videogo.open.R.drawable.play_play_selector);
        ...
        if (mCameraInfo != null) {
            ...
            mRealPlayFullPlayBtn.setBackgroundResource(com.videogo.open.R.drawable.play_full_play_selector);
            mRealPlayFullCaptureBtn.setEnabled(false);
            mRealPlayFullRecordBtn.setEnabled(false);
            mRealPlayPtzBtn.setEnabled(false);
        }
        ...
        switch (msg.what) {
            ...
            case EZRealPlayConstants.MSG_REALPLAY_PASSWORD_ERROR:
                if (mCameraInfo != null && mCameraInfo.getShareStatus() == 1) {
                    ...
                    // 处理播放密码错误
                    handlePasswordError(com.videogo.open.R.string.realplay_password_error_title,
                            com.videogo.open.R.string.realplay_password_error_message3, com.videogo.open.R.string.realplay_password_error_message1);
                }
                break;
            case EZRealPlayConstants.MSG_REALPLAY_ENCRYPT_PASSWORD_ERROR:
                if (mCameraInfo != null && mCameraInfo.getShareStatus() == 1) {
                    ...
                    // 处理播放密码错误
                    handlePasswordError(com.videogo.open.R.string.realplay_encrypt_password_error_title,
                            com.videogo.open.R.string.realplay_encrypt_password_error_message, 0);
                }
                break;
    ...
    private void handlePtzControlFail(Message msg) {
        ...
        switch (msg.arg1) {
            case ErrorCode.ERROR_CAS_PTZ_CONTROL_CALLING_PRESET_FAILED:// 正在调用预置点，键控动作无效
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.camera_lens_too_busy, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_PRESETING_FAILE:// 当前正在调用预置点
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_is_preseting, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_CONTROL_TIMEOUT_CRUISE_TRACK_FAILED:// 键控动作超时(当前正在轨迹巡航)
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_control_timeout_cruise_track_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_INVALID_POSITION_FAILED:// 当前预置点信息无效
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_preset_invalid_position_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_CURRENT_POSITION_FAILED:// 该预置点已是当前位置
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_preset_current_position_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_SOUND_LOCALIZATION_FAILED:// 设备正在响应本次声源定位
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_preset_sound_localization_failed, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_MIRRORING_FAILED:// 设备正在镜像操作（设备镜像要几秒钟，防止频繁镜像操作）
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_operation_too_frequently, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_PRESET_EXCEED_MAXNUM_FAILED:// 当前预置点超过最大个数
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_preset_exceed_maxnum_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRIVACYING_FAILED:// 设备处于隐私遮蔽状态（关闭了镜头，再去操作云台相关）
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_privacying_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_TTSING_FAILED:// 设备处于语音对讲状态(区别以前的语音对讲错误码，云台单独列一个）
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_mirroring_failed, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_ROTATION_RIGHT_LIMIT_FAILED:// 设备云台旋转到达右限位
                ...
                break;
            default:
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.ptz_operation_failed, msg.arg1);
                break;
        }
    }
...
/*
    ...
    private void handleVoiceTalkFailed(int errorCode, String msg, int retryCount) {
        ...
        switch (errorCode) {
            ...
            case CASClientSDKException.CASCLIENT_CAS_TALK_CHANNEL_BUSY:
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.realplay_play_talkback_fail_ison);
                break;
            ...
            case ErrorCode.ERROR_TTS_DEV_PRIVACY_ON:
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.realplay_play_talkback_fail_privacy);
                break;
            case ErrorCode.ERROR_TTS_DEV_NO_ONLINE:
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.realplay_fail_device_not_exist);
                break;
            ...
            case ErrorCode.ERROR_TTS_HNADLE_TIMEOUT:
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.realplay_play_talkback_request_timeout, errorCode);
                break;
            ...
            case ErrorCode.ERROR_CAS_AUDIO_SEND_ERROR:
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.realplay_play_talkback_network_exception, errorCode);
                break;
            default:
                Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.realplay_play_talkback_fail, errorCode);
                break;
        }
    }
    ...
    private void handleSetVedioModeFail(int errorCode) {
        ...
        Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.realplay_set_vediomode_fail, errorCode);
    }
    ...
    private void handleRecordFail(int errorCode) {
        Utils.showToast(EZRealPlayActivity.this, com.videogo.open.R.string.remoteplayback_record_fail, errorCode);
        if (mIsRecording) {
            stopRealPlayRecord();
        }
    }
    ...
    private void updateRealPlayFailUI(int errorCode) {
        ...
        switch (errorCode) {
            ...
            case CASClientSDKException.CASCLIENT_MSG_PU_NO_RESOURCE:
                txt = getString(com.videogo.open.R.string.remoteplayback_over_link);
                break;
            ...
            case InnerException.INNER_DEVICE_NOT_EXIST:
                ...
                txt = getString(com.videogo.open.R.string.realplay_fail_device_not_exist);
                break;
            case ErrorCode.ERROR_WEB_DIVICE_SO_TIMEOUT:
                txt = getString(com.videogo.open.R.string.realplay_fail_connect_device);
                break;
            case HCNetSDKException.NET_DVR_RTSP_PRIVACY_STATUS:
            case RtspClientException.RTSPCLIENT_PRIVACY_STATUS:
                txt = getString(com.videogo.open.R.string.realplay_set_fail_status);
                break;
            case ErrorCode.ERROR_RTSP_SHARE_TIME_OVER:
                txt = getString(com.videogo.open.R.string.realplay_share_time_over);
                break;
            case ErrorCode.ERROR_RTSP_TOKEN_NO_PERMISSION:
                if (mCameraInfo != null && mCameraInfo.getShareStatus() == 1) {
                    txt = getString(com.videogo.open.R.string.realplay_share_no_permission);
                } else {
                    txt = getString(com.videogo.open.R.string.realplay_no_permission);
                }
                break;
            case ErrorCode.ERROR_RTSP_NO_VIDEO_SOURCE:
                txt = getString(com.videogo.open.R.string.realplay_play_no_video_source);
                break;
            ...
            case ErrorCode.ERROR_INNER_DEVICE_PASSWORD_IS_NULL:
                txt = getString(com.videogo.open.R.string.device_password_is_null);
                break;
            ...
            default:
                txt = Utils.getErrorTip(this, com.videogo.open.R.string.realplay_play_fail, errorCode);
                break;
        }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        int i = v.getId();
        if (i == com.videogo.open.R.id.realplay_pages_gallery) {
            mRealPlayTouchListener.touch(event);

        } else if (i == com.videogo.open.R.id.realplay_full_operate_bar) {
            return true;
        } else {
        }
        return false;
    ...
    private void showSharePasswordError() {
        // 处理播放密码错误
        handlePasswordError(com.videogo.open.R.string.realplay_encrypt_password_error_title, com.videogo.open.R.string.realplay_password_error_message4,
                0);
    }
    ...
    private void initLoadingUI() {
        mRealPlayLoadingRl = (RelativeLayout) findViewById(com.videogo.open.R.id.realplay_loading_rl);
        mRealPlayTipTv = (TextView) findViewById(com.videogo.open.R.id.realplay_tip_tv);
        mRealPlayPlayIv = (ImageView) findViewById(com.videogo.open.R.id.realplay_play_iv);
        mRealPlayPlayLoading = (LoadingTextView) findViewById(com.videogo.open.R.id.realplay_loading);
        mRealPlayPlayPrivacyLy = (LinearLayout) findViewById(com.videogo.open.R.id.realplay_privacy_ly);

        // 设置点击图标的监听响应函数
        mRealPlayPlayIv.setOnClickListener(this);

        mPageAnimIv = (ImageView) findViewById(com.videogo.open.R.id.realplay_page_anim_iv);
    }
