...
public class OpenYSService {
    ...
    public static void openYSServiceDialog(final Context context, final OpenYSServiceListener l) {
        ...
        .setTitle(com.videogo.open.R.string.please_input_phone_txt)
        .setIcon(android.R.drawable.ic_dialog_info)   
        .setView(smsVerifyView)
        .setPositiveButton(com.videogo.open.R.string.open_ys_service, new DialogInterface.OnClickListener() {
    ...
    private static class OpenYSServiceTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (mErrorCode == 0) {
                Utils.showToast(mContext, com.videogo.open.R.string.open_ys_service_success);
        ...
        protected void onError(int errorCode) {
            switch (errorCode) {
                ...
                case ErrorCode.ERROR_WEB_HARDWARE_SIGNATURE_ERROR:
                    ...
                    break;
                default:
                    Utils.showToast(mContext, com.videogo.open.R.string.open_ys_service_fail, mErrorCode);
                    break;
            }
        }
    }
