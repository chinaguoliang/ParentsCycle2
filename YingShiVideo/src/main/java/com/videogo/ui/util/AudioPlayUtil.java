...
public class AudioPlayUtil {
    ...
    private AudioPlayUtil(Application application) {
        ...
        mSoundMap.put(CAPTURE_SOUND, mSoundPool.load(mContext, com.videogo.open.R.raw.paizhao, 0));
        mSoundMap.put(RECORD_SOUND, mSoundPool.load(mContext, com.videogo.open.R.raw.record, 0));
    };
