...
public class SecureValidate {
    ...
    public static void secureValidateDialog(final Context context, final SecureValidateListener l) {
        ...
        ViewGroup smsVerifyView = (ViewGroup) mLayoutInflater.inflate(com.videogo.open.R.layout.open_ysservice_dialog, null, true);
        
        final LinearLayout phoneLy = (LinearLayout) smsVerifyView.findViewById(com.videogo.open.R.id.phone_ly);
        ...
        .setTitle(com.videogo.open.R.string.secure_validate)
        .setIcon(android.R.drawable.ic_dialog_info)   
        .setView(smsVerifyView)
        .setPositiveButton(com.videogo.open.R.string.submit_secure_validate, new DialogInterface.OnClickListener() {
    ...
    private static class SecureValidateTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (mErrorCode == 0) {
                Utils.showToast(mContext, com.videogo.open.R.string.secure_validate_success);
        ...
        protected void onError(int errorCode) {
            switch (errorCode) {
                ...
                case ErrorCode.ERROR_WEB_HARDWARE_SIGNATURE_ERROR:
                    ...
                    break;
                default:
                    Utils.showToast(mContext, com.videogo.open.R.string.secure_validatee_fail, mErrorCode);
                    break;
            }
        }
    }
