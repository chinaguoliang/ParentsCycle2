...
public class VerifySmsCodeUtil {
    ...
    public static void openSmsVerifyDialog(final int type, final Context context, final OnVerifyListener l) {
        ...
        ViewGroup smsVerifyView = (ViewGroup) mLayoutInflater.inflate(com.videogo.open.R.layout.sms_verify_dialog, null, true);
        
        final EditText signEt = (EditText) smsVerifyView.findViewById(com.videogo.open.R.id.sign_et);
        final EditText phoneEt = (EditText) smsVerifyView.findViewById(com.videogo.open.R.id.phone_et);
        final EditText smsCodeEt = (EditText) smsVerifyView.findViewById(com.videogo.open.R.id.sms_code_et);
        final EditText userIdEt = (EditText) smsVerifyView.findViewById(com.videogo.open.R.id.userid_et);
        final Button getSmsBtn = (Button) smsVerifyView.findViewById(com.videogo.open.R.id.get_sms_code_btn);
        ...
        .setTitle(com.videogo.open.R.string.please_input_sign_get_sms_txt)
        .setIcon(android.R.drawable.ic_dialog_info)   
        .setView(smsVerifyView)
        .setPositiveButton(com.videogo.open.R.string.submit_sms_code, new DialogInterface.OnClickListener() {
    ...
    private static class GetSmsCodeTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onError(int errorCode) {
            switch (errorCode) {
                ...
                default:
                    Utils.showToast(mContext, com.videogo.open.R.string.get_sms_code_fail, mErrorCode);
                    break;
            }
        }
    }
    ...
    private static class VerifySmsCodeTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (mErrorCode == 0) {
                Utils.showToast(mContext, com.videogo.open.R.string.verify_sms_code_success);
        ...
        protected void onError(int errorCode) {
            switch (errorCode) {
                ...
                case ErrorCode.ERROR_WEB_SMS_VERIFY_BIND_ERROR:
                    Utils.showToast(mContext, com.videogo.open.R.string.sms_verify_bind_error);
                    break;
                default:
                    Utils.showToast(mContext, com.videogo.open.R.string.verify_sms_code_fail, mErrorCode);
                    break;
            }
        }
    }
