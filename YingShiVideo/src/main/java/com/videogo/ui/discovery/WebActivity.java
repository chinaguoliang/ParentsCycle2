...
public class WebActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.videogo.open.R.layout.web_page);
    ...
    private void findViews() {
        ...
        mPullToRefreshWebView = (PullToRefreshWebView) findViewById(com.videogo.open.R.id.webview);
    ...
    public class CustomWebViewClient extends WebViewClientEx {
        ...
        public void onPageStartedCompat(WebView view, String url, Bitmap favicon) {
            ...
            if (mProgressView != null)
                mProgressView.startAnimation(AnimationUtils.loadAnimation(WebActivity.this, com.videogo.open.R.anim.rotate_clockwise));
        }
