...
public class CityConfigFragment extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(com.videogo.open.R.layout.fragment_city_config, container, false);
		mRefreshListView = (PullToRefreshListView) view.findViewById(com.videogo.open.R.id.cifyConfigList);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                new AsyncTaskBase<Void, Void, String>(getActivity(), true) {
                    ...
                    protected void realOnPostExecute(String cityName) {
                        ...
                        builder.setTitle(com.videogo.open.R.string.cityConfig).setMessage(cityName).create().show();
                    }
		...
		getDialog().setTitle(com.videogo.open.R.string.cities);
...
class CityConfigAdapter extends VideoGoBaseAdapter<ConfigCity> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(com.videogo.open.R.layout.city_config_item, null);
	...
	private class ViewHolder {
		...
		public ViewHolder(View view) {
			cityKey = (TextView) view.findViewById(com.videogo.open.R.id.cityKey);
			cityName = (TextView) view.findViewById(com.videogo.open.R.id.cityName);
		}
