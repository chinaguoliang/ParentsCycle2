...
public class AccountSafeModifyPhonePaser implements PaserJson {
    ...
    public Object getErrorBeanData(String msg) {
        ...
        meData.setObj(new AccountSafeModifyPhoneInfo());
        return meData;
    }
