 ...
 */
public class AnnouncementCommentSaveInfoPaser implements PaserJson{
    @Override
    public Object parseJSonObject(NetBeanSuper response) throws JSONException {
        Log.d("result", "the response code:" + response);
        response.setObj(new AnnouncementCommentSaveInfo());
        return response;
    }
    ...
    public Object getErrorBeanData(String msg) {
        ...
        meData.setObj(new AnnouncementCommentSaveInfo());
        return meData;
    }
