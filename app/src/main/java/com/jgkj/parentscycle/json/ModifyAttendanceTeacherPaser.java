...
public class ModifyAttendanceTeacherPaser implements PaserJson {
    ...
    public Object getErrorBeanData(String msg) {
        ...
        meData.setObj(new ModifyAttendanceTeacherInfo());
        return meData;
    }
